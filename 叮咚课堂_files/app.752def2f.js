(window.webpackJsonp = window.webpackJsonp || []).push([
	["app"], {
		...
		i9i0: function (module, exports, __webpack_require__) {
				...
				try {
					...
					! function () {
						var t = Array.prototype,
							...
							o = n.hasOwnProperty,
							a = (e.bind, t.forEach),
							s = (t.indexOf, Array.isArray),
							c = {},
							u = _.each = function (t, e, n) {
								if (null == t) return !1;
								if (a && t.forEach === a) t.forEach(e, n);
								else if (t.length === +t.length) {
									for (var r = 0, i = t.length; r < i; r++)
										if (r in t && e.call(n, t[r], r, t) === c) return !1
								} else
									for (var s in t)
										if (o.call(t, s) && e.call(n, t[s], s, t) === c) return !1
							};
						_.extend = function (t) {
							return u(r.call(arguments, 1), function (e) {
							...
							return !(!t || !o.call(t, "callee"))
						}, _.toArray = function (t) {
							return t ? t.toArray ? t.toArray() : _.isArray(t) ? r.call(t) : _.isArguments(t) ? r.call(t) : _.values(t) : []
						}, _.values = function (t) {
							var e = [];
							...
							return "[object Number]" == i.call(t) && /[\d\.]+/.test(String(t))
							...
							return _.each(t, function (e, n) {
								_.isDate(e) ? t[n] = _.formatDate(e) : _.isObject(e) && (t[n] = _.encodeDates(e))
							}), t
							...
							if (t) e = t.indexOf("landscape") > -1 ? "landscape" : "portrait";
								...
								n("(orientation: landscape)").matches ? e = "landscape" : n("(orientation: portrait)").matches && (e = "portrait")
							}
							return e
							...
							n || (n = {});
							var c = function () {
								s = !1 === n.leading ? 0 : _.now(), a = null, o = t.apply(r, i), a || (r = i = null)
							};
							return function () {
								var u = _.now();
								s || !1 !== n.leading || (s = u);
								var l = e - (u - s);
								return r = this, i = arguments, l <= 0 || l > e ? (a && (clearTimeout(a), a = null), s = u, o = t.apply(r, i), a || (r = i = null)) : a || !1 === n.trailing || (a = setTimeout(c, l)), o
							}
							...
							_.isObject(t) && _.each(t, function (e, n) {
								_.isObject(e) ? _.searchObjDate(t[n]) : _.isDate(e) && (t[n] = _.formatDate(e))
							})
						}, _.searchZZAppStyle = function (t) {
							void 0 !== t.properties.$project && (t.project = t.properties.$project, delete t.properties.$project), void 0 !== t.properties.$token && (t.token = t.properties.$token, delete t.properties.$token)
							...
							_.isObject(t) && _.each(t, function (e, n) {
								_.isObject(e) ? _.searchObjString(t[n]) : _.isString(e) && (t[n] = _.formatString(e))
							})
						}, _.searchConfigData = function (t) {
							if ("object" == typeof t && t.$option) {
								var e = t.$option;
								return delete t.$option, e
							}
							return {}
						}, _.unique = function (t) {
							for (var e, n = [], r = {}, i = 0; i < t.length; i++)(e = t[i]) in r || (r[e] = !0, n.push(e));
							return n
						}, _.strip_sa_properties = function (t) {
							return _.isObject(t) ? (_.each(t, function (e, n) {
								if (_.isArray(e)) {
									var r = [];
									_.each(e, function (t) {
										_.isString(t) ? r.push(t) : sd.log("您的数据-", n, e, "的数组里的值必须是字符串,已经将其删除")
									}), 0 !== r.length ? t[n] = r : (delete t[n], sd.log("已经删除空的数组"))
								}
								_.isString(e) || _.isNumber(e) || _.isDate(e) || _.isBoolean(e) || _.isArray(e) || "$option" === n || (sd.log("您的数据-", n, e, "-格式不满足要求，我们已经将其删除"), delete t[n])
							}), t) : t
							...
							var e, n, r, i = "",
								o = 0;
							for (e = n = 0, o = t.length, r = 0; r < o; r++) {
								var a = t.charCodeAt(r),
									s = null;
								a < 128 ? n++ : s = a > 127 && a < 2048 ? String.fromCharCode(a >> 6 | 192, 63 & a | 128) : String.fromCharCode(a >> 12 | 224, a >> 6 & 63 | 128, 63 & a | 128), null !== s && (n > e && (i += t.substring(e, n)), i += s, e = n = r + 1)
							}
							...
							var e, n, r, i, o, a, s, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
								l = 0,
								f = 0,
								p = "",
								d = [];
							...
							t = _.utf8Encode(t);
							do {
								e = t.charCodeAt(l++), n = t.charCodeAt(l++), r = t.charCodeAt(l++), i = (c = e << 16 | n << 8 | r) >> 18 & 63, o = c >> 12 & 63, a = c >> 6 & 63, s = 63 & c, d[f++] = u.charAt(i) + u.charAt(o) + u.charAt(a) + u.charAt(s)
							} while (l < t.length);
							...
							return function () {
								...
								var n = t() + "-" + Math.random().toString(16).replace(".", "") + "-" + function (t) {
									function e(t, e) {
										var n, r = 0;
										for (n = 0; n < e.length; n++) r |= o[n] << 8 * n;
										return t ^ r
									}
									var n, r, i = navigator.userAgent,
										o = [],
										a = 0;
									for (n = 0; n < i.length; n++) r = i.charCodeAt(n), o.unshift(255 & r), o.length >= 4 && (a = e(a, o), o = []);
									return o.length > 0 && (a = e(a, o)), a.toString(16)
								}() + "-" + e + "-" + t();
								return n || (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(2, 15)
							}
							...
							var e = function (t) {
								this._fields = {
									...
									QueryString: 9,
									Fragment: 10
								}, this._values = {}, this._regex = null, this._regex = /^((\w+):\/\/)?((\w+):?(\w+)?@)?([^\/\?:]+):?(\d+)?(\/?[^\?#]+)?\??([^#]+)?#?(\w*)/, void 0 !== t && this._parse(t)
							};
							return e.prototype.setUrl = function (t) {
								this._parse(t)
								...
								for (var n in t) e = new RegExp(n + "[^&]+").test(e) ? e.replace(new RegExp(n + "[^&]+"), n + "=" + t[n]) : "&" === e.slice(-1) ? e + n + "=" + t[n] : "" === e ? n + "=" + t[n] : e + "&" + n + "=" + t[n];
								this._values.QueryString = e
							}, e.prototype.getUrl = function () {
								var t = "";
								return t += this._values.Origin, t += this._values.Port ? ":" + this._values.Port : "", t += this._values.Path, t += this._values.QueryString ? "?" + this._values.QueryString : "", t += this._values.Fragment ? "#" + this._values.Fragment : ""
							}, e.prototype.getUrl = function () {
								var t = "";
								return t += this._values.Origin, t += this._values.Port ? ":" + this._values.Port : "", t += this._values.Path, t += this._values.QueryString ? "?" + this._values.QueryString : ""
							}, e.prototype._parse = function (t) {
								this._initValues();
								var e = this._regex.exec(t);
								if (!e) throw "DPURLParser::_parse -> Invalid URL";
								for (var n in this._fields) void 0 !== e[this._fields[n]] && (this._values[n] = e[this._fields[n]]);
							...
							t._getPath = function () {
								...
								function (e, n, r) {
									var i = !(!_.isObject(sd.para.heatmap) || !sd.para.heatmap.useCapture);
									if (e && e.addEventListener) e.addEventListener(n, function (e) {
										...
										e[o] = function (e, n, r) {
											return function (i) {
												if (i = i || t(window.event)) {
													i.target = i.srcElement;
													var o, a, s = !0;
													return "function" == typeof r && (o = r(i)), a = n.call(e, i), !1 !== o && !1 !== a || (s = !1), s
												}
											}
										}(e, r, a)
									}
							...
							get: function (t) {
								for (var e = t + "=", n = document.cookie.split(";"), r = 0; r < n.length; r++) {
									...
									if (0 == i.indexOf(e)) return _.decodeURIComponent(i.substring(e.length, i.length))
								}
								return null
							},
							set: function (t, e, n, r, i) {
								r = void 0 === r ? sd.para.cross_subdomain : r;
								var o = "",
									a = "",
									s = "";
								...
								if (0 !== n) {
									var u = new Date;
									"s" === String(n).slice(-1) ? u.setTime(u.getTime() + 1e3 * Number(String(n).slice(0, -1))) : u.setTime(u.getTime() + 24 * n * 60 * 60 * 1e3), a = "; expires=" + u.toGMTString()
								}
								i && (s = "; secure"), document.cookie = t + "=" + encodeURIComponent(e) + a + "; path=/" + o + s
							},
							remove: function (t, e) {
								e = void 0 === e ? sd.para.cross_subdomain : e, _.cookie.set(t, "", -1, e)
							},
							getCookieName: function (t, e) {
								var n = "";
								if (e = e || location.href, !1 === sd.para.cross_subdomain) {
									try {
										n = _.URL(e).hostname
									} catch (t) {}
									n = "string" == typeof n && "" !== n ? "sajssdk_2015_" + t + "_" + n.replace(/\./g, "_") : "sajssdk_2015_root_" + t
							...
							isSupport: function () {
								var t = !0,
									e = "__sensorsdatasupport__",
									n = "testIsSupportStorage";
								try {
									sessionStorage && sessionStorage.setItem ? (sessionStorage.setItem(e, n), sessionStorage.removeItem(e, n), t = !0) : t = !1
								} catch (e) {
									t = !1
								}
								return t
							...
							if (t) return void 0 !== window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest ? new XMLHttpRequest : "undefined" != typeof XDomainRequest ? new XDomainRequest : null;
							...
							t.timeout = t.timeout || 2e4, t.credentials = void 0 === t.credentials || t.credentials;
							var n = _.xhr(t.cors);
							if (!n) return !1;
							...
							try {
								"object" == typeof n && "timeout" in n ? n.timeout = t.timeout : setTimeout(function () {
									n.abort()
								}, t.timeout + 500)
							} catch (e) {
								try {
							...
							try {
								...
								t.data && (t.cors || n.setRequestHeader("X-Requested-With", "XMLHttpRequest"), "application/json" === t.contentType ? n.setRequestHeader("Content-type", "application/json; charset=UTF-8") : n.setRequestHeader("Content-type", "application/x-www-form-urlencoded"))
							} catch (t) {}
							n.send(t.data || null)
							...
							}, t)).type && ((e = document.createElement("link")).rel = "stylesheet", e.href = t.url), "js" === t.type && ((e = document.createElement("script")).async = "async", e.setAttribute("charset", "UTF-8"), e.src = t.url, e.type = "text/javascript"), e.onload = e.onreadystatechange = function () {
								this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (t.success(), e.onload = e.onreadystatechange = null)
							}, e.onerror = function () {
								t.error(), e.onerror = null
							}, t.appendCall(e)
						}, _.getHostname = function (t, e) {
							e && "string" == typeof e || (e = "hostname解析异常");
							var n = null;
							try {
								n = _.URL(t).hostname
							} catch (t) {}
							...
							var e = {},
								n = t.split("?"),
								r = n[1] || "";
							return r && (e = _.getURLSearchParams("?" + r)), e
						}, _.getURLSearchParams = function (t) {
							for (var e = function (t) {
									return decodeURIComponent(t)
								}, n = {}, r = (t = t || "").substring(1), i = r.split("&"), o = 0; o < i.length; o++) {
								var a = i[o].indexOf("=");
								if (-1 !== a) {
									var s = i[o].substring(0, a),
										c = i[o].substring(a + 1);
									s = e(s), c = e(c), n[s] = c
								}
							}
							...
							var e = {},
								n = ["hash", "host", "hostname", "href", "origin", "password", "pathname", "port", "protocol", "search", "username"];
							if ("function" == typeof window.URL && function () {
								...
								e.hostname && "string" == typeof e.pathname && 0 !== e.pathname.indexOf("/") && (e.pathname = "/" + e.pathname), e.searchParams = function () {
									var t = _.getURLSearchParams(e.search);
									return {
										get: function (e) {
											return t[e]
										}
							...
							var e = sd.para.current_domain;
							switch (typeof e) {
								case "function":
									var n = e();
									return "" === n || "" === _.trim(n) ? "url解析失败" : -1 !== n.indexOf(".") ? n : "url解析失败";
								case "string":
									return "" === e || "" === _.trim(e) ? "url解析失败" : -1 !== e.indexOf(".") ? e : "url解析失败";
								default:
									var r = _.getCookieTopLevelDomain();
									return "" === t ? "url解析失败" : "" === r ? "url解析失败" : r
							}
						}, _.getCookieTopLevelDomain = function (t) {
							var e = (t = t || window.location.hostname).split(".");
							if (_.isArray(e) && e.length >= 2 && !/^(\d+\.)+\d+$/.test(t))
								for (var n = "." + e.splice(e.length - 1, 1); e.length > 0;)
									if (n = "." + e.splice(e.length - 1, 1) + n, document.cookie = "sensorsdata_domain_test=true; path=/; domain=" + n, -1 !== document.cookie.indexOf("sensorsdata_domain_test=true")) {
										var r = new Date;
										return r.setTime(r.getTime() - 1e3), document.cookie = "sensorsdata_domain_test=true; expires=" + r.toGMTString() + "; path=/; domain=" + n, n
									} return ""
							...
							addClass: function (t) {
								...
								return -1 === e.indexOf(" " + t + " ") && (this.ele.className = this.ele.className + ("" === this.ele.className ? "" : " ") + t), this
							},
							removeClass: function (t) {
								var e = " " + this.ele.className + " ";
								return -1 !== e.indexOf(" " + t + " ") && (this.ele.className = e.replace(" " + t + " ", " ").slice(1, -1)), this
							},
							hasClass: function (t) {
								var e = " " + this.ele.className + " ";
							...
							attr: function (t, e) {
								return "string" == typeof t && _.isUndefined(e) ? this.ele.getAttribute(t) : ("string" == typeof t && (e = String(e), this.ele.setAttribute(t, e)), this)
							},
							offset: function () {
								var t = this.ele.getBoundingClientRect();
								if (t.width || t.height) {
									var e = this.ele.ownerDocument,
										n = e.documentElement;
									return {
							...
							wrap: function (t) {
								...
								return this.ele.parentNode.insertBefore(e, this.ele), e.appendChild(this.ele), _.ry(e)
							},
							getCssStyle: function (t) {
								var e = this.ele.style.getPropertyValue(t);
								if (e) return e;
								var n = null;
								if ("function" == typeof window.getMatchedCSSRules && (n = getMatchedCSSRules(this.ele)), !n || !_.isArray(n)) return null;
								for (var r = n.length - 1; r >= 0; r--) {
									var i = n[r];
									if (e = i.style.getPropertyValue(t)) return e
								}
							},
							...
							parent: function () {
								...
								return t = t && 11 !== t.nodeType ? t : null, _.ry(t)
							}
						}, _.strToUnicode = function (t) {
							if ("string" != typeof t) return sd.log("转换unicode错误", t), t;
							for (var e = "", n = 0; n < t.length; n++) e += "\\" + t.charCodeAt(n).toString(16);
							return e
						}, _.getReferrer = function (t) {
							var t = t || document.referrer;
							return "string" != typeof t ? "取值异常_referrer异常_" + String(t) : (0 === t.indexOf("https://www.baidu.com/") && (t = t.split("?")[0]), "string" == typeof (t = t.slice(0, sd.para.max_referrer_string_length)) ? t : "")
						}, _.getKeywordFromReferrer = function (t) {
							t = t || document.referrer;
							var e = sd.para.source_type.keyword;
							if (document && "string" == typeof t) {
								if (0 === t.indexOf("http")) {
									var n = _.getReferSearchEngine(t),
										r = _.getQueryParamsFromUrl(t);
									if (_.isEmptyObject(r)) return "未取到值";
									var i = null;
									for (var o in e)
										if (n === o && "object" == typeof r)
											if (i = e[o], _.isArray(i))
							...
							var e = _.getHostname(t);
							if (!e || "hostname解析异常" === e) return "";
							var n = (sd.para.source_type.keyword, {
								baidu: [/^.*\.baidu\.com$/],
								bing: [/^.*\.bing\.com$/],
							...
							for (var r in n)
								for (var i = n[r], o = 0, a = i.length; o < a; o++)
									if (i[o].test(e)) return r;
							return "未知搜索引擎"
						}, _.getSourceFromReferrer = function () {
							function t(t, e) {
								for (var n = 0; n < t.length; n++)
									if (-1 !== e.split("?")[0].indexOf(t[n])) return !0
							}
							var e = "(" + sd.para.source_type.utm.join("|") + ")\\=[^&]+",
								n = sd.para.source_type.search,
								r = sd.para.source_type.social,
								i = document.referrer || "",
								o = _.info.pageProp.url;
							if (o) {
								var a = o.match(new RegExp(e));
								return a && a[0] ? "付费广告流量" : t(n, i) ? "自然搜索流量" : t(r, i) ? "社交网站流量" : "" === i ? "直接流量" : "引荐流量"
							}
							return "获取url异常"
						}, _.info = {
							initPage: function () {
								var t = _.getReferrer(),
									e = location.href,
									n = _.getCurrentDomain(e);
								n || sd.debug.jssdkDebug("url_domain异常_" + e + "_" + n), this.pageProp = {
									referrer: t,
									referrer_host: t ? _.getHostname(t) : "",
									url: e,
									url_host: _.getHostname(e, "url_host取值异常"),
									url_domain: n
								}
							},
							pageProp: {},
							campaignParams: function () {
								var t = sd.source_channel_standard.split(" "),
									e = "",
									n = {};
								return _.isArray(sd.para.source_channel) && sd.para.source_channel.length > 0 && (t = t.concat(sd.para.source_channel), t = _.unique(t)), _.each(t, function (t) {
									(e = _.getQueryParam(location.href, t)).length && (n[t] = e)
								}), n
							},
							campaignParamsStandard: function (t, e) {
								...
								var n = _.info.campaignParams(),
									r = {},
									i = {};
								for (var o in n) - 1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + o + " ") ? r[t + o] = n[o] : i[e + o] = n[o];
								return {
									$utms: r,
									otherUtms: i
								}
							...
							function r(t) {
								...
								var o = !1;
								setTimeout(r, 1e3), sd.track(e, n, r)
							}
							var i = null;
							return (t = t || {}).ele && (i = t.ele), t.event && (i = t.target ? t.target : t.event.target), n = n || {}, !(!i || "object" != typeof i) && (!i.href || /^javascript/.test(i.href) || i.target || i.download || i.onclick ? (sd.track(e, n), !1) : (t.event && r(t.event), void(t.ele && _.addEvent(t.ele, "click", function (t) {
								r(t)
							}))))
						}
					}(), sd.para_default = {
						...
						use_app_track: !1,
						ignore_oom: !0
					}, sd.addReferrerHost = function (t) {
						var e = "取值异常";
						_.isObject(t.properties) && (t.properties.$first_referrer && (t.properties.$first_referrer_host = _.getHostname(t.properties.$first_referrer, e)), "track" === t.type && ("$referrer" in t.properties && (t.properties.$referrer_host = "" === t.properties.$referrer ? "" : _.getHostname(t.properties.$referrer, e)), sd.para.preset_properties.latest_referrer && sd.para.preset_properties.latest_referrer_host && (t.properties.$latest_referrer_host = "" === t.properties.$latest_referrer ? "" : _.getHostname(t.properties.$latest_referrer, e))))
					}, sd.addPropsHook = function (t) {
						sd.para.preset_properties && sd.para.preset_properties.url && "track" === t.type && void 0 === t.properties.$url && (t.properties.$url = window.location.href)
					}, sd.initPara = function (t) {
						sd.para = t || sd.para || {};
						var e, n = {};
						if (_.isObject(sd.para.is_track_latest))
							for (var r in sd.para.is_track_latest) n["latest_" + r] = sd.para.is_track_latest[r];
						for (e in sd.para.preset_properties = _.extend({}, sd.para_default.preset_properties, n, sd.para.preset_properties || {}), sd.para_default) void 0 === sd.para[e] && (sd.para[e] = sd.para_default[e]);
						...
						_.localStorage.isSupport() && _.isSupportCors() && "object" == typeof localStorage ? !0 === sd.para.batch_send ? (sd.para.batch_send = _.extend({}, i), sd.para.use_client_time = !0) : "object" == typeof sd.para.batch_send && (sd.para.use_client_time = !0, sd.para.batch_send = _.extend({}, i, sd.para.batch_send)) : sd.para.batch_send = !1;
						...
						if ("object" == typeof sd.para.source_type && (sd.para.source_type.utm = _.isArray(sd.para.source_type.utm) ? sd.para.source_type.utm.concat(o) : o, sd.para.source_type.search = _.isArray(sd.para.source_type.search) ? sd.para.source_type.search.concat(a) : a, sd.para.source_type.social = _.isArray(sd.para.source_type.social) ? sd.para.source_type.social.concat(s) : s, sd.para.source_type.keyword = _.isObject(sd.para.source_type.keyword) ? _.extend(c, sd.para.source_type.keyword) : c), _.isObject(sd.para.heatmap) && (sd.para.heatmap.clickmap = sd.para.heatmap.clickmap || "default", sd.para.heatmap.scroll_notice_map = sd.para.heatmap.scroll_notice_map || "default", sd.para.heatmap.scroll_delay_time = sd.para.heatmap.scroll_delay_time || 4e3, sd.para.heatmap.scroll_event_duration = sd.para.heatmap.scroll_event_duration || 18e3, sd.para.heatmap.renderRefreshTime = sd.para.heatmap.renderRefreshTime || 1e3, sd.para.heatmap.loadTimeout = sd.para.heatmap.loadTimeout || 1e3), "object" == typeof sd.para.server_url && sd.para.server_url.length)
							for (e = 0; e < sd.para.server_url.length; e++) /sa\.gif[^\/]*$/.test(sd.para.server_url[e]) || (sd.para.server_url[e] = sd.para.server_url[e].replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2"));
					...
					}, sd.setPreConfig = function (t) {
						sd.para = t.para, sd._q = t._q
					}, sd.setInitVar = function () {
						sd._t = sd._t || 1 * new Date, sd.lib_version = "1.14.13", sd.is_first_visitor = !1, sd.source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term"
					}, sd.log = function () {
						...
						if (_.sessionStorage.isSupport()) try {
							...
							sd.log("enableLocalLog error: " + t.message)
						}
						...
						apph5: function (t) {
							var e = "app_h5打通失败-",
								...
								i = t.step,
								o = t.data;
							"all" !== r && "console" !== r || sd.log(n[i]), ("all" === r || "code" === r) && _.isObject(sd.para.is_debug) && sd.para.is_debug.apph5 && (o.type && "profile" === o.type.slice(0, 7) || (o.properties._jssdk_debug_info = "apph5-" + String(i)))
						}
					};
					var commonWays = {
						setOnlineState: function (t) {
							if (!0 === t && _.isObject(sd.para.jsapp) && "function" == typeof sd.para.jsapp.getData) {
								sd.para.jsapp.isOnline = !0;
								var e = sd.para.jsapp.getData();
								_.isArray(e) && e.length > 0 && _.each(e, function (t) {
									_.isJSONString(t) && sd.sendState.pushSend(JSON.parse(t))
								})
						...
						setProfileLocal: function (t) {
							if (!_.localStorage.isSupport()) return sd.setProfile(t), !1;
							if (!_.isObject(t) || _.isEmptyObject(t)) return !1;
							var e = _.localStorage.parse("sensorsdata_2015_jssdk_profile"),
								n = !1;
							if (_.isObject(e) && !_.isEmptyObject(e)) {
								for (var r in t) !(r in e && e[r] !== t[r]) && r in e || (e[r] = t[r], n = !0);
								n && (_.localStorage.set("sensorsdata_2015_jssdk_profile", JSON.stringify(e)), sd.setProfile(t))
							} else _.localStorage.set("sensorsdata_2015_jssdk_profile", JSON.stringify(t)), sd.setProfile(t)
						},
						...
						trackHeatMap: function (t, e, n) {
							if ("object" == typeof t && t.tagName) {
								var r = t.tagName.toLowerCase(),
									i = t.parentNode.tagName.toLowerCase();
								"button" !== r && "a" !== r && "a" !== i && "button" !== i && "input" !== r && "textarea" !== r && heatmap.start(null, t, r, e, n)
							}
						},
						trackAllHeatMap: function (t, e, n) {
							if ("object" == typeof t && t.tagName) {
								var r = t.tagName.toLowerCase();
								heatmap.start(null, t, r, e, n)
							}
						},
						autoTrackSinglePage: function (t, e) {
							function n() {
								var t = _.info.campaignParams(),
									e = {};
								for (var n in t) - 1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + n + " ") ? e["$" + n] = t[n] : e[n] = t[n];
								return e
							}
							...
							function r(t, e) {
								sd.track("$pageview", _.extend({
									...
									$title: document.title
								}, t, n()), e), i = location.href
							}
							if (this.autoTrackIsUsed) var i = _.info.pageProp.url;
							else var i = _.info.pageProp.referrer;
							t = _.isObject(t) ? t : {}, t = _.isObject(t) ? t : {}, sd.is_first_visitor && !t.not_set_profile && (sd.setOnceProfile(_.extend({
							...
							}, n())), sd.is_first_visitor = !1), t.not_set_profile && delete t.not_set_profile, sd.is_first_visitor && !t.not_set_profile && (sd.setOnceProfile(_.extend({
								$first_visit_time: new Date,
								$first_referrer: _.getReferrer(),
								$first_browser_language: navigator.language || "取值异常",
								$first_browser_charset: "string" == typeof document.charset ? document.charset.toUpperCase() : "取值异常",
								$first_traffic_source_type: _.getSourceFromReferrer(),
								$first_search_keyword: _.getKeywordFromReferrer()
							}, n())), sd.is_first_visitor = !1), t.not_set_profile && delete t.not_set_profile, r(t, e), this.autoTrackSinglePage = r
						},
						autoTrackWithoutProfile: function (t, e) {
							t = _.isObject(t) ? t : {}, this.autoTrack(_.extend(t, {
								not_set_profile: !0
							}), e)
						},
						autoTrack: function (t, e) {
							...
							var n = _.info.campaignParams(),
								r = {};
							for (var i in n) - 1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + i + " ") ? r["$" + i] = n[i] : r[i] = n[i];
							sd.is_first_visitor && !t.not_set_profile && (sd.setOnceProfile(_.extend({
								$first_visit_time: new Date,
								$first_referrer: _.getReferrer(),
								$first_browser_language: navigator.language || "取值异常",
								$first_browser_charset: "string" == typeof document.charset ? document.charset.toUpperCase() : "取值异常",
								$first_traffic_source_type: _.getSourceFromReferrer(),
								$first_search_keyword: _.getKeywordFromReferrer()
							}, r)), sd.is_first_visitor = !1), t.not_set_profile && delete t.not_set_profile;
							var o = location.href;
							sd.para.is_single_page && _.addHashEvent(function () {
								var n = _.getReferrer(o);
								sd.track("$pageview", _.extend({
									$referrer: n,
									$url: location.href,
									$url_path: location.pathname,
									$title: document.title
								}, r, t), e), o = location.href
							}), sd.track("$pageview", _.extend({
								$referrer: _.getReferrer(),
								$url: location.href,
								$url_path: location.pathname,
								$title: document.title
							}, r, t), e), this.autoTrackIsUsed = !0
						},
					...
					sd.quick = function () {
						var t = Array.prototype.slice.call(arguments),
							e = t[0],
							n = t.slice(1);
						return "string" == typeof e && commonWays[e] ? commonWays[e].apply(commonWays, n) : void("function" == typeof e ? e.apply(sd, n) : sd.log("quick方法中没有这个功能" + t[0]))
					}, sd.track = function (t, e, n) {
						saEvent.check({
							event: t,
							properties: e
						}) && saEvent.send({
					...
					}, sd.trackLink = function (t, e, n) {
						"object" == typeof t && t.tagName ? _.trackLink({
							ele: t
						}, e, n) : "object" == typeof t && t.target && t.event && _.trackLink(t, e, n)
					}, sd.trackLinks = function (t, e, n) {
						return n = n || {}, !(!t || "object" != typeof t) && !(!t.href || /^javascript/.test(t.href) || t.target) && void _.addEvent(t, "click", function (r) {
							function i() {
								o || (o = !0, location.href = t.href)
							}
							r.preventDefault();
							var o = !1;
							setTimeout(i, 1e3), sd.track(e, n, i)
						})
					}, sd.setProfile = function (t, e) {
						saEvent.check({
							propertiesMust: t
						}) && saEvent.send({
							type: "profile_set",
					...
					}, sd.setOnceProfile = function (t, e) {
						saEvent.check({
							propertiesMust: t
						}) && saEvent.send({
					...
					}, sd.appendProfile = function (t, e) {
						saEvent.check({
							propertiesMust: t
						}) && (_.each(t, function (e, n) {
							_.isString(e) ? t[n] = [e] : _.isArray(e) || (delete t[n], sd.log("appendProfile属性的值必须是字符串或者数组"))
						}), _.isEmptyObject(t) || saEvent.send({
							type: "profile_append",
							properties: t
						}, e))
					}, sd.incrementProfile = function (t, e) {
						var n = t;
						_.isString(t) && ((t = {})[n] = 1), saEvent.check({
							propertiesMust: t
						}) && (function (t) {
							for (var e in t)
								if (!/-*\d+/.test(String(t[e]))) return !1;
							return !0
						}(t) ? saEvent.send({
							type: "profile_increment",
							properties: t
						}, e) : sd.log("profile_increment的值只能是数字"))
					}, sd.deleteProfile = function (t) {
						saEvent.send({
							type: "profile_delete"
						}, t), store.set("distinct_id", _.UUID()), store.set("first_id", "")
					}, sd.unsetProfile = function (t, e) {
						var n = t,
							r = {};
						_.isString(t) && (t = []).push(n), _.isArray(t) ? (_.each(t, function (t) {
							_.isString(t) ? r[t] = !0 : sd.log("profile_unset给的数组里面的值必须时string,已经过滤掉", t)
						}), saEvent.send({
							type: "profile_unset",
							properties: r
						}, e)) : sd.log("profile_unset的参数是数组")
					}, sd.identify = function (t, e) {
						"number" == typeof t && (t = String(t));
						var n = store.getFirstId();
						void 0 === t ? n ? store.set("first_id", _.UUID()) : store.set("distinct_id", _.UUID()) : saEvent.check({
							distinct_id: t
						}) ? !0 === e ? n ? store.set("first_id", t) : store.set("distinct_id", t) : n ? store.change("first_id", t) : store.change("distinct_id", t) : sd.log("identify的参数必须是字符串")
					}, sd.trackSignup = function (t, e, n, r) {
						if (saEvent.check({
								distinct_id: t,
								event: e,
								properties: n
							...
							store.set("distinct_id", t), saEvent.send({
								original_id: i,
								distinct_id: t,
								type: "track_signup",
								event: e,
					...
					}, sd.trackAbtest = function (t, e) {}, sd.registerPage = function (t) {
						saEvent.check({
							properties: t
						}) ? _.extend(_.info.currentProps, t) : sd.log("register输入的参数有误")
					}, sd.clearAllRegister = function (t) {
						store.clearAllProps(t)
					}, sd.register = function (t) {
						saEvent.check({
							properties: t
						}) ? store.setProps(t) : sd.log("register输入的参数有误")
					}, sd.registerOnce = function (t) {
						saEvent.check({
							properties: t
						}) ? store.setPropsOnce(t) : sd.log("registerOnce输入的参数有误")
					}, sd.registerSession = function (t) {
						saEvent.check({
							properties: t
						}) ? store.setSessionProps(t) : sd.log("registerSession输入的参数有误")
					}, sd.registerSessionOnce = function (t) {
						saEvent.check({
							properties: t
						}) ? store.setSessionPropsOnce(t) : sd.log("registerSessionOnce输入的参数有误")
					}, sd.login = function (t, e) {
						if ("number" == typeof t && (t = String(t)), saEvent.check({
								distinct_id: t
							})) {
							var n = store.getFirstId(),
								r = store.getDistinctId();
							t !== r ? (n || store.set("first_id", r), sd.trackSignup(t, "$SignUp", {}, e)) : e && e()
						} else sd.log("login的参数必须是字符串"), e && e()
					}, sd.logout = function (t) {
						var e = store.getFirstId();
						e ? (store.set("first_id", ""), !0 === t ? store.set("distinct_id", _.UUID()) : store.set("distinct_id", e)) : sd.log("没有first_id，logout失败")
						...
						add: function (t) {
							_.isObject(t) && (this.writeStore(t), "track_signup" !== t.type && "$pageview" !== t.event || this.sendStrategy())
						},
						remove: function (t) {
							this.sendingData > 0 && --this.sendingData, _.isArray(t) && t.length > 0 && _.each(t, function (t) {
								_.localStorage.remove(t)
							})
						},
						send: function (t) {
							var e = this,
								n = _.isArray(sd.para.server_url) ? sd.para.server_url[0] : sd.para.server_url;
							_.ajax({
								url: n,
								type: "POST",
								data: "data_list=" + encodeURIComponent(_.base64Encode(JSON.stringify(t.vals))),
								credentials: !1,
						...
						sendPrepare: function (t) {
							var e = t.vals,
								n = sd.para.batch_send.one_send_max_length,
								r = e.length;
							if (r > 0)
								if (r <= n) this.send({
									keys: t.keys,
									...
									for (var i = 0; i * n < r; i++) this.send({
										keys: t.keys.splice(0, n),
										vals: e.splice(0, n)
									})
						},
						sendStrategy: function () {
							var t = this.readStore();
							t.keys.length > 0 && 0 === this.sendingData && (this.sendingData = Math.ceil(t.vals.length / sd.para.batch_send.one_send_max_length), this.sendPrepare(t))
						},
						...
						readStore: function () {
							for (var t = [], e = [], n = null, r = (new Date).getTime(), i = localStorage.length, o = 0; o < i; o++) {
								var a = localStorage.key(o);
								0 === a.indexOf("sawebjssdk-") && /^sawebjssdk\-\d+$/.test(a) && ((n = localStorage.getItem(a)) ? (n = _.safeJSONParse(n)) && _.isObject(n) ? (n._flush_time = r, t.push(a), e.push(n)) : (localStorage.removeItem(a), sd.log("localStorage-数据parse异常" + n)) : (localStorage.removeItem(a), sd.log("localStorage-数据取值异常" + n)))
							}
							return {
								keys: t,
								vals: e
						...
						writeStore: function (t) {
							var e = String(Math.random()).slice(2, 5) + String(Math.random()).slice(2, 5) + String((new Date).getTime()).slice(3);
							localStorage.setItem("sawebjssdk-" + e, JSON.stringify(t))
						}
					}, sd.batchSend = new BatchSend;
					var dataSend = {
						getSendUrl: function (t, e) {
							var n = _.base64Encode(e),
								r = "crc=" + _.hashCode(n);
						...
						getSendData: function (t) {
							var e = _.base64Encode(t),
								n = "crc=" + _.hashCode(e);
							return "data=" + encodeURIComponent(e) + "&ext=" + encodeURIComponent(n)
						},
						getInstance: function (t) {
							var e = this.getSendType(t),
								n = new this[e](t),
								r = n.start;
							return n.start = function () {
								...
								if (!this.received) {
									...
									var e = this;
									t ? sd.para.queue_timeout - sd.para.callback_timeout <= 0 ? e.close() : setTimeout(function () {
										e.close()
									}, sd.para.queue_timeout - sd.para.callback_timeout) : e.close()
								}
							}, n
						},
						getSendType: function (t) {
							var e = ["image", "ajax", "beacon"],
								n = e[0];
							return "beacon" === (n = t.config && _.indexOf(e, t.config.send_type) > -1 ? t.config.send_type : sd.para.send_type) && "function" != typeof navigator.sendBeacon && (n = "image"), "ajax" === n && !1 === _.isSupportCors() && (n = "image"), n
						},
						image: function (t) {
							this.callback = t.callback, this.img = document.createElement("img"), this.img.width = 1, this.img.height = 1, sd.para.img_use_crossorigin && (this.img.crossOrigin = "anonymous"), this.data = t.data, this.server_url = dataSend.getSendUrl(t.server_url, t.data)
						}
					};
					dataSend.image.prototype.start = function () {
						...
						this.img.src = ""
					}, dataSend.ajax = function (t) {
						this.callback = t.callback, this.server_url = t.server_url, this.data = dataSend.getSendData(t.data)
					...
					var sendState = {};
					sd.sendState = sendState, sendState.queue = _.autoExeQueue(), sendState.requestData = null, sendState.getSendCall = function (t, e, n) {
						if (sd.is_heatmap_render_mode) return !1;
						if (sd.readyState.state < 3) return sd.log("初始化没有完成"), !1;
						t._track_id = Number(String(Math.random()).slice(2, 5) + String(Math.random()).slice(2, 4) + String((new Date).getTime()).slice(-4)), sd.para.use_client_time && (t._flush_time = (new Date).getTime());
						var r = t;
						if (t = JSON.stringify(t), this.requestData = {
								data: r,
								config: e,
								callback: n
							}, !sd.para.use_app_track && sd.para.batch_send && localStorage.length < 200) return sd.log(r), sd.batchSend.add(this.requestData.data), !1;
						if (!0 === sd.para.use_app_track || "only" === sd.para.use_app_track)
							...
							}, r))) ? "function" == typeof n && n() : (sd.debug.apph5({
								data: r,
								step: "3.1",
								output: "all"
							...
							else if (!/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream) !0 === sd.para.use_app_track && (sd.debug.apph5({
							data: r,
							step: "2",
							output: "all"
							...
							if (/sensors-verify/.test(navigator.userAgent)) {
								var o = navigator.userAgent.match(/sensors-verify\/([^\s]+)/);
								if (o && o[0] && "string" == typeof o[1] && 2 === o[1].split("?").length) {
									o = o[1].split("?");
									var a = null,
										s = null;
									try {
										a = _.URL(sd.para.server_url).hostname, s = _.URL(sd.para.server_url).searchParams.get("project") || "default"
									} catch (t) {}
									a && a === o[0] && s && s === o[1] ? ((i = document.createElement("iframe")).setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({
										server_url: sd.para.server_url
									}, r)))), document.documentElement.appendChild(i), i.parentNode.removeChild(i), i = null, "function" == typeof n && n()) : (sd.debug.apph5({
										data: r,
										step: "3.2",
										output: "all"
									}), this.prepareServerUrl())
								}
							} else(i = document.createElement("iframe")).setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({
								server_url: sd.para.server_url
							}, r)))), document.documentElement.appendChild(i), i.parentNode.removeChild(i), i = null, "function" == typeof n && n()
						} else "mui" === sd.para.use_app_track ? _.isObject(window.plus) && window.plus.SDAnalytics && window.plus.SDAnalytics.trackH5Event && window.plus.SDAnalytics.trackH5Event(t) : (sd.debug.apph5({
							data: r,
							step: "1",
							output: "code"
						}), this.prepareServerUrl());
						...
						if ("object" == typeof this.requestData.config && this.requestData.config.server_url) this.sendCall(this.requestData.config.server_url, this.requestData.callback);
							...
							for (var t = 0; t < sd.para.server_url.length; t++) this.sendCall(sd.para.server_url[t]);
						else this.sendCall(sd.para.server_url, this.requestData.callback)
					}, sendState.sendCall = function (t, e) {
						var n = {
							server_url: t,
						...
						_.isObject(sd.para.jsapp) && !sd.para.jsapp.isOnline && "function" == typeof sd.para.jsapp.setData ? (delete n.callback, n = JSON.stringify(n), sd.para.jsapp.setData(n)) : this.pushSend(n)
					}, sendState.pushSend = function (t) {
						var e = dataSend.getInstance(t),
							n = this;
						e.close = function () {
							n.queue.close()
					...
					saEvent.checkOption = {
						...
						str: function (t) {
							return !!_.isString(t) || (sd.log("请检查参数格式,必须是字符串"), !0)
						},
						properties: function (t) {
							return _.strip_sa_properties(t), !(t && (_.isObject(t) ? !this.checkPropertiesKey(t) && (sd.log("properties 里的自定义属性名需要是合法的变量名，不能以数字开头，且只包含：大小写字母、数字、下划线，自定义属性不能以 $ 开头"), 0) : (sd.log("properties可以没有，但有的话必须是对象"), 0)))
						},
						propertiesMust: function (t) {
							return _.strip_sa_properties(t), void 0 === t || !_.isObject(t) || _.isEmptyObject(t) ? (sd.log("properties必须是对象且有值"), !0) : !!this.checkPropertiesKey(t) || (sd.log("properties 里的自定义属性名需要是合法的变量名，不能以数字开头，且只包含：大小写字母、数字、下划线，自定义属性不能以 $ 开头"), !0)
						},
						event: function (t) {
							return !(!_.isString(t) || !this.regChecks.regName.test(t)) || (sd.log("请检查参数格式，eventName 必须是字符串，且需是合法的变量名，即不能以数字开头，且只包含：大小写字母、数字、下划线和 $,其中以 $ 开头的表明是系统的保留字段，自定义事件名请不要以 $ 开头"), !0)
						},
						test_id: "str",
						group_id: "str",
						distinct_id: function (t) {
							return !(!_.isString(t) || !/^.{1,255}$/.test(t)) || (sd.log("distinct_id必须是不能为空，且小于255位的字符串"), !1)
						}
					}, saEvent.check = function (t) {
						for (var e in t)
							if (!this.checkOption.check(e, t[e])) return !1;
						return !0
					}, saEvent.send = function (t, e) {
						var n = {
						...
						_.isObject(t) && _.isObject(t.properties) && !_.isEmptyObject(t.properties) && t.properties.$lib_detail && (n.lib.$lib_detail = t.properties.$lib_detail, delete t.properties.$lib_detail), _.extend(n, sd.store.getUnionId(), t), _.isObject(t.properties) && !_.isEmptyObject(t.properties) && _.extend(n.properties, t.properties), t.type && "profile" === t.type.slice(0, 7) || (n.properties = _.extend({}, _.info.properties(), store.getProps(), store.getSessionProps(), _.info.currentProps, n.properties), sd.para.preset_properties.latest_referrer && !_.isString(n.properties.$latest_referrer) && (n.properties.$latest_referrer = "取值异常"), sd.para.preset_properties.latest_search_keyword && !_.isString(n.properties.$latest_search_keyword) && (n.properties.$latest_search_keyword = "取值异常"), sd.para.preset_properties.latest_traffic_source_type && !_.isString(n.properties.$latest_traffic_source_type) && (n.properties.$latest_traffic_source_type = "取值异常"), sd.para.preset_properties.latest_landing_page && !_.isString(n.properties.$latest_landing_page) && (n.properties.$latest_landing_page = "取值异常")), n.properties.$time && _.isDate(n.properties.$time) ? (n.time = 1 * n.properties.$time, delete n.properties.$time) : sd.para.use_client_time && (n.time = 1 * new Date), _.searchObjDate(n), _.searchObjString(n), _.searchZZAppStyle(n);
						var r = _.searchConfigData(n.properties);
						saNewUser.checkIsAddSign(n), saNewUser.checkIsFirstTime(n), sd.addReferrerHost(n), sd.addPropsHook(n), !0 === sd.para.debug_mode ? (sd.log(n), this.debugPath(JSON.stringify(n), e)) : sd.sendState.getSendCall(n, r, e)
					}, saEvent.debugPath = function (t, e) {
						var n = t,
							r = "";
						r = -1 !== sd.para.debug_mode_url.indexOf("?") ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(t)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(t)), _.ajax({
							url: r,
							type: "GET",
							cors: !0,
							header: {
							...
							success: function (t) {
								!0 === _.isEmptyObject(t) ? alert("debug数据发送成功" + n) : alert("debug失败 错误原因" + JSON.stringify(t))
							}
						})
					};
					var store = sd.store = {
							...
							toState: function (t) {
								var e = null;
								if (null != t && _.isJSONString(t))
									if (e = JSON.parse(t), this._state = _.extend(e), e.distinct_id) {
										if ("object" == typeof e.props) {
											for (var n in e.props) "string" == typeof e.props[n] && (e.props[n] = e.props[n].slice(0, sd.para.max_referrer_string_length));
											this.save()
										}
									} else this.set("distinct_id", _.UUID()), sd.debug.distinct_id("1", t);
								else this.set("distinct_id", _.UUID()), sd.debug.distinct_id("2", t)
							},
							initSessionState: function () {
								var t = _.cookie.get("sensorsdata2015session"),
									e = null;
								null !== t && "object" == typeof (e = JSON.parse(t)) && (this._sessionState = e || {})
							},
							...
							setSessionProps: function (t) {
								...
								_.extend(e, t), this.sessionSave(e)
							},
							setSessionPropsOnce: function (t) {
								var e = this._sessionState;
								_.coverExtend(e, t), this.sessionSave(e)
							},
							setProps: function (t, e) {
								var n = {};
								for (var r in n = e ? t : _.extend(this._state.props || {}, t)) "string" == typeof n[r] && (n[r] = n[r].slice(0, sd.para.max_referrer_string_length));
								this.set("props", n)
							},
							setPropsOnce: function (t) {
								var e = this._state.props || {};
								_.coverExtend(e, t), this.set("props", e)
							},
							clearAllProps: function (t) {
								if (this._sessionState = {}, _.isArray(t) && t.length > 0)
									for (var e = 0; e < t.length; e++) _.isString(t[e]) && -1 === t[e].indexOf("latest_") && t[e] in this._state.props && delete this._state.props[t[e]];
								else
									for (var e in this._state.props) 1 !== e.indexOf("latest_") && delete this._state.props[e];
								this.sessionSave({}), this.save()
							},
							sessionSave: function (t) {
								this._sessionState = t, _.cookie.set("sensorsdata2015session", JSON.stringify(this._sessionState), 0)
							},
							save: function () {
							...
							getCookieName: function () {
								...
								if (!1 === sd.para.cross_subdomain) {
									try {
										t = _.URL(location.href).hostname
									} catch (t) {}
									t = "string" == typeof t && "" !== t ? "sa_jssdk_2015_" + t.replace(/\./g, "_") : "sa_jssdk_2015_root"
								} else t = "sensorsdata2015jssdkcross";
								return t
							},
							init: function () {
								this.initSessionState();
								var t = _.UUID(),
									e = _.cookie.get(this.getCookieName());
								null === e ? (sd.is_first_visitor = !0, this.set("distinct_id", t)) : (_.isJSONString(e) && JSON.parse(e).distinct_id || (sd.is_first_visitor = !0), this.toState(e)), saNewUser.setDeviceId(t), saNewUser.storeInitCheck(), saNewUser.checkIsFirstLatest()
							}
						},
						saNewUser = {
							checkIsAddSign: function (t) {
								"track" === t.type && (_.cookie.getNewUser() ? t.properties.$is_first_day = !0 : t.properties.$is_first_day = !1)
							},
							...
							setDeviceId: function (t) {
								var e = null,
									n = _.cookie.get("sensorsdata2015jssdkcross"),
									r = {};
								null != n && _.isJSONString(n) && (r = JSON.parse(n)).$device_id && (e = r.$device_id), e = e || t, !0 === sd.para.cross_subdomain ? store.set("$device_id", e) : (r.$device_id = e, _.cookie.set("sensorsdata2015jssdkcross", JSON.stringify(r), null, !0)), sd.para.is_track_device_id && (_.info.currentProps.$device_id = e)
							},
							storeInitCheck: function () {
								if (sd.is_first_visitor) {
									...
									_.cookie.set(_.cookie.getCookieName("new_user"), "1", 3600 * e.h + 60 * e.m + e.s + "s"), this.is_first_visit_time = !0
								} else _.cookie.getNewUser() || (this.checkIsAddSign = function (t) {
							...
							checkIsFirstLatest: function () {
								for (var t = _.info.pageProp.url_domain, e = ["$utm_source", "$utm_medium", "$utm_campaign", "$utm_content", "$utm_term"], n = store.getProps(), r = 0; r < e.length; r++) e[r] in n && delete n[e[r]];
								store.setProps(n, !0);
								var i = {};
								if ("" === t && (t = "url解析失败"), _.each(sd.para.preset_properties, function (e, n) {
										if (-1 === n.indexOf("latest_")) return !1;
										if (n = n.slice(7), e) {
											if ("utm" !== n && "url解析失败" === t) i["$latest_" + n] = "url的domain解析失败";
											else if (_.isReferralTraffic(document.referrer)) switch (n) {
										...
										} else if ("utm" === n && sd.store._state.props)
											for (var r in sd.store._state.props) 0 === r.indexOf("$latest_utm") && 0 === r.indexOf("_latest_") || delete sd.store._state.props[r];
										else sd.store._state.props && "$latest_" + n in sd.store._state.props && delete sd.store._state.props["$latest_" + n]
									}), sd.register(i), sd.para.preset_properties.latest_utm) {
									var o = _.info.campaignParamsStandard("$latest_", "_latest_"),
										a = o.$utms,
										s = o.otherUtms;
						...
						heatmap = sd.heatmap = {
							setNotice: function (t) {
								sd.is_heatmap_render_mode = !0, sd.para.heatmap || (sd.errorMsg = "您SDK没有配置开启点击图，可能没有数据！"), t && t[0] && t[1] && "http:" === t[1].slice(0, 5) && "https" === location.protocol && (sd.errorMsg = "您的当前页面是https的地址，神策分析环境也必须是https！"), sd.para.heatmap_url || (sd.para.heatmap_url = location.protocol + "//static.sensorsdata.cn/sdk/" + sd.lib_version + "/heatmap.min.js")
							},
							getDomIndex: function (t) {
								if (!t.parentNode) return -1;
								for (var e = 0, n = t.tagName, r = t.parentNode.children, i = 0; i < r.length; i++)
									if (r[i].tagName === n) {
										if (t === r[i]) return e;
										e++
									} return -1
							...
							selector: function (t) {
								var e = t.parentNode && 9 == t.parentNode.nodeType ? -1 : this.getDomIndex(t);
								return t.getAttribute && t.getAttribute("id") && (!sd.para.heatmap || sd.para.heatmap && "not_use_id" !== sd.para.heatmap.element_selector) ? "#" + t.getAttribute("id") : t.tagName.toLowerCase() + (~e ? ":nth-of-type(" + (e + 1) + ")" : "")
							},
							getDomSelector: function (t, e) {
								if (!t || !t.parentNode || !t.parentNode.children) return !1;
								e = e && e.join ? e : [];
								var n = t.nodeName.toLowerCase();
								return t && "body" !== n && 1 == t.nodeType ? (e.unshift(this.selector(t)), t.getAttribute && t.getAttribute("id") && sd.para.heatmap && "not_use_id" !== sd.para.heatmap.element_selector ? e.join(" > ") : this.getDomSelector(t.parentNode, e)) : (e.unshift("body"), e.join(" > "))
							},
							na: function () {
							...
							W: function (t) {
								var e = parseInt(+t.clientX + +this.na(), 10),
									t = parseInt(+t.clientY + +this.i(), 10);
								return {
									x: isNaN(e) ? 0 : e,
									y: isNaN(t) ? 0 : t
								}
							...
							start: function (t, e, n, r, i) {
								var o = _.isObject(r) ? r : {},
									a = _.isFunction(i) ? i : _.isFunction(r) ? r : void 0;
								if (sd.para.heatmap && sd.para.heatmap.collect_element && !sd.para.heatmap.collect_element(e)) return !1;
								var s = this.getDomSelector(e),
									c = _.getEleInfo({
										target: e
									});
								if (c.$element_selector = s || "", sd.para.heatmap && sd.para.heatmap.custom_property) {
									var u = sd.para.heatmap.custom_property(e);
									_.isObject(u) && (c = _.extend(c, u))
								}
								c = _.extend(c, o), "a" === n && sd.para.heatmap && !0 === sd.para.heatmap.isTrackLink ? _.trackLink({
									event: t,
									target: e
								}, "$WebClick", c) : sd.track("$WebClick", c, a)
							},
							hasElement: function (t) {
								var e = t._getPath();
								if (_.isArray(e) && e.length > 0)
									for (var n = 0; n < e.length; n++)
										if (e[n] && e[n].tagName && "a" === e[n].tagName.toLowerCase()) return e[n];
								return !1
							},
							initScrollmap: function () {
								...
								var t = function (t) {
									var e = {};
									return e.timeout = t.timeout || 1e3, e.func = t.func, e.hasInit = !1, e.inter = null, e.main = function (t, e) {
										this.func(t, e), this.inter = null
									}, e.go = function (t) {
										var n = {};
										this.inter || (n.$viewport_position = document.documentElement && document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop || 0, n.$viewport_position = Math.round(n.$viewport_position) || 0, n.$viewport_height = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight || 0, n.$viewport_width = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth || 0, t ? e.main(n, !0) : this.inter = setTimeout(function () {
											e.main(n)
										}, this.timeout))
									}, e
								}({
									...
									func: function (t, e) {
										...
										(i > sd.para.heatmap.scroll_delay_time && n - t.$viewport_position != 0 || e) && (t.$url = location.href, t.$title = document.title, t.$url_path = location.pathname, t.event_duration = Math.min(sd.para.heatmap.scroll_event_duration, parseInt(i) / 1e3), sd.track("$WebStay", t)), this.current_time = r
									}
								});
							...
							initHeatmap: function () {
								...
								return !(!_.isObject(sd.para.heatmap) || "default" !== sd.para.heatmap.clickmap) && !(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (e) {
									...
									"a" === o || "button" === o ? t.start(n, r.parentNode, o) : t.start(n, r, i)
								}) : _.addEvent(document, "click", function (e) {
									var n = e || window.event;
									if (!n) return !1;
									var r = n.target || n.srcElement;
									...
									if (!r || !r.parentNode || !r.parentNode.children) return !1;
									var o = r.parentNode;
									if ("a" === i || "button" === i || "input" === i || "textarea" === i) t.start(n, r, i);
									else if ("button" === o.tagName.toLowerCase() || "a" === o.tagName.toLowerCase()) t.start(n, o, r.parentNode.tagName.toLowerCase());
									else if ("area" === i && "map" === o.tagName.toLowerCase() && _.ry(o).prev().tagName && "img" === _.ry(o).prev().tagName.toLowerCase()) t.start(n, _.ry(o).prev(), _.ry(o).prev().tagName.toLowerCase());
									else {
										var a = t.hasElement(e);
										a && t.start(n, a, a.tagName.toLowerCase())
									}
								})))
							},
							prepare: function (t) {
								function e(t, e, n) {
									sd.para.heatmap_url ? _.loadScript({
										success: function () {
											setTimeout(function () {
												"undefined" != typeof sa_jssdk_heatmap_render && (sa_jssdk_heatmap_render(sd, t, e, n), "object" == typeof console && "function" == typeof console.log && sd.heatmap_version && (sd.heatmap_version, sd.lib_version))
											}, 0)
										},
										error: function () {},
										type: "js",
								...
								var n = location.search.match(/sa-request-id=([^&#]+)/),
									r = location.search.match(/sa-request-type=([^&#]+)/),
									i = location.search.match(/sa-request-url=([^&#]+)/);
								n && n[0] && n[1] ? (heatmap.setNotice(i), _.sessionStorage.isSupport() && (i && i[0] && i[1] && sessionStorage.setItem("sensors_heatmap_url", decodeURIComponent(i[1])), sessionStorage.setItem("sensors_heatmap_id", n[1]), r && r[0] && r[1] ? "1" === r[1] || "2" === r[1] || "3" === r[1] ? (r = r[1], sessionStorage.setItem("sensors_heatmap_type", r)) : r = null : r = null !== sessionStorage.getItem("sensors_heatmap_type") ? sessionStorage.getItem("sensors_heatmap_type") : null), e(n[1], r)) : _.sessionStorage.isSupport() && "string" == typeof sessionStorage.getItem("sensors_heatmap_id") ? (heatmap.setNotice(), e(sessionStorage.getItem("sensors_heatmap_id"), sessionStorage.getItem("sensors_heatmap_type"), location.href)) : (t(), _.isObject(sd.para.heatmap) && (this.initHeatmap(), this.initScrollmap()))
							}
						};
					if (sd.init = function (t) {
							function e() {
								var t = null,
									e = null;
								window.sensorsdata_app_js_bridge_call_js = function (n) {
									! function (n) {
										t = n, _.isJSONString(t) && (t = JSON.parse(t)), e && (e(t), e = null, t = null)
									}(n)
								}, sd.getAppStatus = function (n) {
									return function () {
										if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
											var t = document.createElement("iframe");
											t.setAttribute("src", "sensorsanalytics://getAppInfo"), document.documentElement.appendChild(t), t.parentNode.removeChild(t), t = null
										}
									}(), "object" == typeof window.SensorsData_APP_JS_Bridge && window.SensorsData_APP_JS_Bridge.sensorsdata_call_app && (t = SensorsData_APP_JS_Bridge.sensorsdata_call_app(), _.isJSONString(t) && (t = JSON.parse(t))), n ? void(null === t ? e = n : (n(t), t = null)) : t
								}
							}
							return !(sd.readyState && sd.readyState.state && sd.readyState.state >= 2) && (sd.setInitVar(), sd.readyState.setState(2), sd.initPara(t), void heatmap.prepare(function () {
								e(), _.info.initPage(), sd.para.is_track_single_page && _.addSinglePageEvent(function (t) {
									var e = function (e) {
										e = e || {}, t !== location.href && (_.info.pageProp.referrer = t, sd.quick("autoTrack", _.extend({
											$url: location.href,
											$referrer: t
										}, e)))
									};
									if ("boolean" == typeof sd.para.is_track_single_page) e();
									else if ("function" == typeof sd.para.is_track_single_page) {
										var n = sd.para.is_track_single_page();
										_.isObject(n) ? e(n) : !0 === n && e()
									}
								}), sd.para.batch_send && sd.batchSend.batchInterval(), sd.store.init(), sd.readyState.setState(3), sd._q && _.isArray(sd._q) && sd._q.length > 0 && _.each(sd._q, function (t) {
									sd[t[0]].apply(sd, Array.prototype.slice.call(t[1]))
								})
							}))
