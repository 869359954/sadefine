! function t(e, r, i) {
            ...
            handleEvent: function (t) {
                switch (t.stopImmediatePropagation(), t.type) {
                    case "DOMAttrModified":
                        ...
                        var o = null;
                        ("undefined" == typeof MutationEvent || t.attrChange !== MutationEvent.ADDITION) && (o = t.prevValue), a(i, function (t) {
                            return !t.attributes || t.attributeFilter && t.attributeFilter.length && -1 === t.attributeFilter.indexOf(e) && -1 === t.attributeFilter.indexOf(r) ? void 0 : t.attributeOldValue ? l(o) : n
                        });
                        break;
    ...
    2: [function (t, e, r) {
        var i, n, o, s, a, u, c, d, h = function (t, e) {
            ...
            l = [].slice;
        d = t("../core/tools/utils"), i = t("../core/dimensions/app_dimension"), s = t("../core/dimensions/page_dimension"), o = t("../core/dimensions/evar_dimension"), a = t("../core/dimensions/people_dimension"), u = t("../core/dimensions/system_dimension"), c = t("../core/dimensions/visitor_dimension"), n = function () {
            function t() {
                this.callback = h(this.callback, this), this.setGioIdByTouchSuccessCallback = h(this.setGioIdByTouchSuccessCallback, this), this.setGioIdByTouch = h(this.setGioIdByTouch, this), this.addRealTimeMessageCallBack = h(this.addRealTimeMessageCallBack, this), this.defaultSamplingFunc = h(this.defaultSamplingFunc, this), this.options = d.assignObj({}, this.defaultOptions), this.started = !1, this._setup(), this.identityWindow(), this.initialCSFields(), this.initialPSFields(), this.commond_stack = []
            }
            var e;
            return t.prototype.version = "2.1.27", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", e = ["page", "vst", "clck", "imp", "chng", "sbmt", "cstm", "pvar", "evar", "ppl", "reengage", "vstr"], t.prototype.defaultOptions = {
                imp: !0,
                hashtag: !1,
                touch: !1,
                bot: !0,
                ...
                for (r in t) n = t[r], r in e && (r = e[r]), "object" == typeof n ? this.apply.apply(this, [r].concat(l.call(n))) : this.apply(r, n);
                i = [];
                for (r in this.options) i.push(window.vds[r] = this.options[r]);
                return i
            }, t.prototype.trackPV = function (t, e) {
                var r, i;
                return t && null != (r = this.observer) && r.pageService.replaceProps(t), null != (i = this.observer) ? i.pageService.sendPV(null, e) : void 0
                ...
                if (t && d.isString(t) && 0 !== t.trim().length) {
                    for (d.isString(t) && this.setAccountId(t), d.isString(e) && null !== e.trim() ? this.setAppId(e) : d.isObject(e) && (r = e), window.vds = {
                            origin: this.circleHost,
                            version: this.version
                        }, this.config(r), o = ["app", "people", "page", "evar", "visitor", "system"], i = 0, n = o.length; n > i; i++) s = o[i], this[s] = this.initDimensions(s);
                ...
                var e, r;
                return 200 === t.status && null != t.response ? (r = JSON.parse(t.response), r.grwng_uid && this.user.setGioId(r.grwng_uid), null != (e = this.observer) ? e.pageService.sendPV({
                    gioId: !0,
                    useNewTime: !1
                }) : void 0) : void 0
                ...
                if (!this.started) try {
                    ...
                    for (this.started = !0, n = this.commond_stack, r = 0, i = n.length; i > r; r++) t = n[r], this.apply.apply(this, t)
                }
    ...
    4: [function (t, e, r) {
        ...
        n = t("../tools/utils"), i = function () {
            function t(t, e, r, i) {
                this.launcher = t, this.observer = e, this.sender = r, this.gruser = i, this.send = this.sender.send, this.utils = n
            }
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            ...
            return a(e, t), e.prototype.set = function (t) {
                ...
                return r = {
                    ...
                    p: this.utils.path()
                }, n = o.vaildVar(t), n && (r["var"] = n), e = this.gruser.getCs1(), e && (r.cs1 = e), r.d = window.location.host || window.vds.accountId, i = this.utils.query(), i.length > 0 && (r.q = i), r
            }, e
        }(i), e.exports = n
    }, {
        "../tools/utils": 18,
    ...
    6: [function (t, e, r) {
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            function e() {
                this.setPS = s(this.setPS, this), this.setName = s(this.setName, this), this.set = s(this.set, this), e.__super__.constructor.apply(this, arguments), this.properties = {}, this.pageService = this.observer.pageService, this.currentUrl = ""
            }
            return a(e, t), e.prototype.set = function (t) {
                var e, r, i;
                ...
                return r = {
                    ...
                    ptm: this.observer.pageLoaded,
                    p: this.utils.path()
                }, n = o.vaildVar(t), n && (r["var"] = n), e = this.gruser.getCs1(), e && (r.cs1 = e), window.vds.appId && (r.appId = window.vds.appId), r.d = window.location.host || window.vds.accountId, i = this.utils.query(), i.length > 0 && (r.q = i), r
    ...
    7: [function (t, e, r) {
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            ...
            return a(e, t), e.prototype.set = function (t) {
                ...
                if (t && window.vds.accountId && this.getId() !== t) return this.people_cache && this.set(this.people_cache), n = this.gruser.lastSessionId, r = this.gruser.sid(), e = a = !0, o = this.gruser.last_sent_sid_with_cs1(), i = this.gruser.last_sent_cs1(), this.getId() && this.getId() !== t && (r = this.gruser.guid(), a = !1), r === n && o === r && this.gruser.last_sent_cs1() !== t && (r = this.gruser.guid()), this.getId() || (a = !1), this.gruser.updateCS1(t, r), s = o && o === r || !o && !i, this.gruser.updateSessionId(r, s), setTimeout(function (t) {
                    return function () {
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            ...
            return a(e, t), e.prototype.track = function (t) {
                ...
                if (t) {
                    ...
                    for (i = n = 0, o = arguments.length; o > n; i = ++n) e = arguments[i], this.utils.isFunction(e) ? r = e : this.utils.isObject(e) ? a = e : 0 === i ? t = e : s = e;
                ...
                return null == e && (e = {}), o.isVaildIdentifier(t) ? (n = {
                    ...
                    n: t
                }, window.vds.appId && (n.appId = window.vds.appId), a = o.vaildEventNumber(r), a && (n.num = a), u = o.vaildVar(e), u && (n["var"] = u), i = this.gruser.getCs1(), i && (n.cs1 = i), n.d = window.location.host || window.vds.accountId, s = this.utils.query(), s.length > 0 && (n.q = s), n) : null
            }, e
        }(i), e.exports = n
    }, {
        "../tools/utils": 18,
    ...
    9: [function (t, e, r) {
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            function e() {
                this._buildVisitorMessage = s(this._buildVisitorMessage, this), this.set = s(this.set, this), e.__super__.constructor.apply(this, arguments)
            }
            return a(e, t), e.prototype.set = function (t) {
                var e, r;
                ...
                return r = {
                    ...
                    t: "vstr",
                    tm: +Date.now()
                }, i = o.vaildVar(t), i && (r["var"] = i), e = this.gruser.getCs1(), e && (r.cs1 = e), r.d = window.location.host || window.vds.accountId, r
            }, e
        }(i), e.exports = n
    }, {
        "../tools/utils": 18,
    ...
    10: [function (t, e, r) {
        var i, n, o, s, a, u;
        u = t("../tools/utils"), n = t("./tagging_node_info"), s = ["I", "SPAN", "EM", "svg"], o = ["TR", "LI", "DL"], a = ["A", "BUTTON"], i = function () {
            function t() {}
            return t.prototype.path = function (t, e) {
                var r, i, o, s, c, d, h, l, p, f, g, v, m, w, y, b, _, S, C;
                if (null == e && (e = !1), s = "", g = !1, i = {}, p = !1, l = !1, _ = void 0, c = 0, b = [], o = [], t === document) return {
                    isIgnore: !0
                };
                if (t.tagName) {
                    for (r = new n(t);
                        ...
                        }, b.push(i.x), m = r.path(), r.isIgnore && (g = !0), !p && r.hasObj() && (p = !0, h = r.grObj), l || (r.hasIdx() ? (l = !0, d = r.grIdx) : (C = r.path(), (-1 !== C.indexOf("/dl") || -1 !== C.indexOf("/tr") || -1 !== C.indexOf("/li")) && (l = !0, d = this.index(r.node)))), y = r.node.parentNode, e && "" !== s && (-1 !== u.indexOf(a, r.node.tagName) || r.isContainer()) && (p ? i.obj = h : u.hasAttr(r.node.parentNode, "data-growing-info") && (i.obj = r.node.parentNode.getAttribute("data-growing-info")), i.x = c, o.push(i)), s = m + s, c++, y && y.tagName);) r = new n(y), 1 === c && (_ = r.node);
                    for (b.reverse(), f = 0, v = o.length; v > f; f++) w = o[f], w.x = b.slice(0, c - w.x).join(""), l && (w.idx = d), p && (w.obj = h);
                    return S = {
                        xpath: s,
                        containerMessage: o,
                        isIgnore: g
    ...
    11: [function (t, e, r) {
        ...
        n = t("../vendor/cookie"), o = t("../tools/guid"), s = t("../tools/utils"), i = function () {
            function t() {
                this.userId = null, this.sessionId = "", this.lastSessionId = "", this.cookie = n, this.guid = o, this.utils = s, this.visitorVar = null, this.cookieDomain()
            }
    ...
    13: [function (t, e, r) {
        ...
        u = t("../tools/utils"), s = u.detectIE() || 0 / 0, a = u.detectIOS() || 0 / 0, 9 >= s && t("json2"), n = t("./messaging_observer"), o = t("../page_service"), i = function () {
            function t(t, e, r, i) {
                this.sender = t, this.gruser = e, this.launcher = r, this.TreeMirror = i, this.setPSForActionMessage = c(this.setPSForActionMessage, this), this.pageChanged = c(this.pageChanged, this), this.sendPageCallback = c(this.sendPageCallback, this), this.content = {}, this.pageService = new o(this.sender, this.gruser, this.launcher)
            }
            ...
            return i = null, b = 3, h = [], s = {}, C = {
                ...
                desc: 1,
                title: 1
            }, p = {}, S = null, l = null, _ = null, r = !0, e = ["TEXTAREA", "HTML", "BODY"], w = ["button", "submit"], y = ["A", "BUTTON", "INPUT", "IMG"], g = ["I", "SPAN", "EM", "svg"], m = ["A", "BUTTON"], v = m, f = ["radio", "checkbox"], t.prototype.sendPageCallback = function (t) {
                    ...
                    initialize: function (t) {
                        return function (e) {
                            ...
                            for (a = {
                                    ...
                                    p: t.currentPath
                                }, t.currentQuery.length > 0 && (a.q = t.currentQuery), i = t.gruser.getCs1(), i && (a.cs1 = i), t.setPSForActionMessage(a), n = [], o = 0, s = e.length; s > o; o++) r = e[o], "use" !== r.tagName && (n = n.concat(t.getLeafNodes(r, e.length)));
                        ...
                        return function (e, r, n, o) {
                            ...
                            if (r.length > 0 && !document.body.className.match(/\bvds-entrytext\b/)) {
                                for (t.gruser.hasSid() || t.pageService.sendPV({
                                        ...
                                        d: window.location.host || window.vds.accountId,
                                        p: t.currentPath
                                    }, s = t.gruser.getCs1(), s && (d.cs1 = s), t.currentQuery.length > 0 && (d.q = t.currentQuery), t.setPSForActionMessage(d), a = [], u = 0, c = r.length; c > u; u++) h = r[u], "use" !== h.tagName && (a = a.concat(t.getLeafNodes(h, h.length)));
                ...
                return h.push(t), 0 > b ? this.sendQueue() : (this.queueTimeout && clearTimeout(this.queueTimeout), this.queueTimeout = setTimeout(function (t) {
                    return function () {
                        return t.sendQueue()
                    }
                ...
                return h.length > 0 && +Date.now() - this.lastActionTime < 12e4 && this.sender.send(h), this.queueTimeout = null, this.lastSentTime = +Date.now(), h = [], b = 3
            }, t.prototype.getLeafNodes = function (t, e) {
                var r, i, n, o, s, a, c, d, h, l, p, f, g, m, w, b, _;
                if (c = [], f = !0, t.leaf) 1 === t.nodeType && ((null != (g = t.attributes) ? g.href : void 0) || null != t.text || null != t.obj) && (p = this.nodeMessage(t, !0), e > 1 && (p.idx = t.idx), c.push(p));
                else if (t.isContainer && (p = this.nodeMessage(t, !0), c.push(p)), 0 === t.childNodes.length && -1 === u.indexOf(y, t.tagName));
                else {
                    for (m = t.childNodes, o = 0, d = m.length; d > o; o++) i = m[o], i.leaf || (f = !1), "use" !== i.tagName && (c = c.concat(this.getLeafNodes(i, t.childNodes.length)));
                    if ((-1 !== u.indexOf(v, t.tagName) || f && ((null != (w = t.attributes) ? w.any : void 0) || t.text)) && (t.text || (n = t.dom, t.text = n ? this.info.containerElemContent(n) : u.parentOfLeafText(t)), p = this.nodeMessage(t, !1), c.push(p)), "SPAN" === t.tagName)
                        for (b = t.childNodes, s = 0, h = b.length; h > s; s++)
                            if (i = b[s], "svg" === i.tagName)
                                for (_ = i.childNodes, a = 0, l = _.length; l > a; a++) r = _[a], 1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (t.text = r.getAttribute("xlink:href"), p = this.nodeMessage(t, !1), c.push(p))
                }
                return c
                ...
                return n = {
                    x: t.path
                }, n.v = u.processText(t.text), "A" === t.tagName && 0 === (null != (o = t.text) ? o.length : void 0) && (n.v = void 0), (null != (s = t.text) ? s.length : void 0) > 50 && (n.v = "A" === t.tagName ? u.processText(t.text.slice(0, 50)) : void 0), (r = t.attributes) && r.href && 0 !== r.href.indexOf("javascript") && (n.h = u.normalizePath(r.href.slice(0, 320)), delete t.attributes.href), t.idx && (n.idx = t.idx), t.obj && (n.obj = t.obj), this.appendMessageAttrs(i, n, t)
                ...
                a = {
                    ...
                    var e;
                    return e = +Date.now() - p.time, e > 1e3 ? clearTimeout(S) : void 0
                }, c = function (t, e) {
                    var i;
                    return i = r ? e.touches[0] : e, i["page" + t.toUpperCase()]
                }, n = function () {
                    var t, e, n, o, s, a, u, c, l, p, g, v, m, w;
                    w = navigator.userAgent, o = /chrome/i.exec(w), n = /android/i.exec(w), r = "ontouchstart" in window && !(o && !n), v = r ? ["touchstart"] : ["mousedown"], m = r ? ["touchend", "touchcancel"] : ["mouseup", "mouseleave"], p = r ? ["touchmove"] : ["mousemove"];
                    ...
                    return function (r) {
                        ...
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            ...
                            for (t.lastActionTime = +Date.now(), h = r.target || r.srcElement; h && 1 === C[h.tagName] && h.parentNode;) h = h.parentNode;
                            ...
                            return t.gruser.hasSid() ? "click" === r.type && t.pageService.sendPVOnSidChanged(t.sendPageCallback) : t.pageService.sendPV({
                                ...
                                addPreProps: !0,
                                useNewTime: !0
                            }, t.sendPageCallback), s = {}, s.u = t.gruser.vid(), s.s = t.gruser.sid(), s.t = a[r.type], s.tm = +Date.now(), s.ptm = t.pageLoaded, s.d = window.location.host || window.vds.accountId, s.p = t.currentPath, t.currentQuery.length > 0 && (s.q = t.currentQuery), n = t.gruser.getCs1(), n && (s.cs1 = n), t.setPSForActionMessage(s), c = "snapshot" === r.type, c && (r.type = "click"), o = t.compute(c ? "click" : r.type, h), t.appendElemAttrs(o, c, h, i), o.x = i.xpath, i.obj && (o.obj = i.obj), i.idx ? o.idx = i.idx : (-1 !== o.x.indexOf("/dl") || -1 !== o.x.indexOf("/tr") || -1 !== o.x.indexOf("/li")) && (o.idx = t.info.index(h)), s.e = 0 === i.containerMessage.length ? [o] : -1 !== u.indexOf(v, i.pnode.tagName) && t.info.onlyContainsChildren(i.pnode, g) ? i.containerMessage : [o].concat(i.containerMessage), c ? t.snapshotCallback(r, s) : t.sender.send([s])
                        }
                    }
                }(this);
                ...
                var r, i, n, o, s, a, c, d, h, l, p, g, m, y, b, _, S, C, O, I;
                if (i = {}, O = e.tagName, "IMG" === O ? (null != (_ = e.src) ? _.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (i.h = e.src) : u.hasAttr(e, "href") && (n = e.getAttribute("href"), n && 0 !== n.indexOf("javascript") && (i.h = u.normalizePath(n.slice(0, 320)))), u.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0) i.v = e.getAttribute("data-growing-title");
                else if (u.hasAttr(e, "title") && e.getAttribute("title").length > 0) i.v = u.processText(e.getAttribute("title"));
                else if ("click" === t)
                    if (this.info.isLeaf(e))
                        if ("IMG" === O) e.alt ? i.v = e.alt : i.h && (a = i.h.split("?")[0], s = a.split("/"), s.length > 0 && (i.v = s[s.length - 1]));
                        else if ("INPUT" === O && -1 !== u.indexOf(w, e.type)) i.v = u.processText(e.value);
                else if ("svg" === O)
                    for (S = e.childNodes, o = 0, y = S.length; y > o; o++) r = S[o], 1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (i.v = r.getAttribute("xlink:href"));
                else I = "", null != e.textContent ? I = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (I = e.innerText.replace(/[\n \t]+/g, " ").trim()), I.length > 0 && (I.length < 50 ? i.v = u.processText(I) : "A" === O && (i.v = u.processText(I.slice(0, 50))));
                else -1 !== u.indexOf(v, O) ? i.v = this.info.containerElemContent(e) : this.info.isParentOfLeaf(e) && (i.v = u.parentOfLeafText(e));
                else if ("change" === t) "TEXTAREA" !== O && ("INPUT" === O ? -1 !== u.indexOf(f, e.type) ? (i.v = u.processText(e.value), h = e.parentNode, "LABEL" === h.tagName ? d = h : "BODY" !== h.tagName && (h = h.parentNode, "LABEL" === h.tagName ? d = h : e.id && (m = h.getElementsByTagName("label"), function () {
                    var t, r, i;
                    for (i = [], t = 0, r = m.length; r > t; t++) g = m[t], i.push(g["for"] === e.id);
                    return i
                }() && (d = g))), null != d && (l = this.info.containerElemContent(d), (null != l ? l.length : void 0) > 0 && (i.obj = l + " (" + e.checked + ")"))) : "password" !== e.type && (u.hasAttr(e, "growing-track") || u.hasAttr(e, "data-growing-track")) && (i.v = u.processText(e.value)) : "SELECT" === O && (i.v = u.processText(e.value), 1 === e.selectedOptions.length && null != e.selectedOptions[0].label && (i.obj = e.selectedOptions[0].label)));
                else if ("submit" === t)
                    for (C = e.getElementsByTagName("input"), p = 0, b = C.length; b > p; p++) c = C[p], ("search" === c.type || "text" === c.type && ("q" === c.id || -1 !== c.id.indexOf("search") || -1 !== c.className.indexOf("search") || "q" === c.name || -1 !== c.name.indexOf("search"))) && (i.x = this.info.path(c).xpath, i.v = u.processText(c.value.trim()));
                return i
                ...
                return u.bind(window, "message", function (t) {
                    return function (e) {
                        var r, i, n, o;
                        try {
                            switch (r = e.data, n = r.mode || r.circleMode, "update-global-env" === n && (window.grCircleEnv = r.add_on_grSource), n) {
                                case "gr-register-SDK-circle":
                                    return t.registerCircleHandler(), u.spreadToInnerIframes(r);
                                case "gr-register-SDK-option":
                                    if (t.canPostRegisterMessage() && "grcw" === window.grSource.name && (o = window.grSource.id, d.call(r.tArr, o) < 0)) return r.tArr.push(window.grSource.id), parent.postMessage(r, "*");
                                    break;
                                case "page-load":
                ...
                for (this.pluginLoaded = !1, a = document.getElementsByTagName("script"), n = 0, o = a.length; o > n; n++)
                    if (i = a[n], u = i.getAttribute("src"), null != u && -1 !== u.indexOf("/outer-circle-plugin.js")) {
                        this.pluginLoaded = !0;
                        break
                    } return this.pluginLoaded ? void 0 : (s = t.add_on_grSource.add_on_origin, window.grCircleEnv = t.add_on_grSource, e = document.createElement("script"), e.type = "text/javascript", e.charset = "UTF-8", e.src = -1 === s.indexOf("http") ? "//" + s + "/assets/javascripts/outer-circle-plugin.js" : s + "/assets/javascripts/outer-circle-plugin.js", document.head.appendChild(e), r = document.createElement("link"), r.rel = "stylesheet", r.href = -1 === s.indexOf("http") ? "//" + s + "/assets/stylesheets/outer-circle-plugin.css" : s + "/assets/stylesheets/outer-circle-plugin.css", document.head.appendChild(r))
                ...
                return "grcw-outer-iframe" === window.grSource.name ? !1 : u.isSpreadPostMessage() ? !0 : parent && "function" == typeof parent.postMessage && window.self !== window.top && window.self !== window.parent
            }, t.prototype.observe = function () {
                var t, e, r;
                if (this.bindEvent(), this.currentPath = u.path(), this.blind()) return void this.sendRegisterCircleOption();
                if (this.currentQuery = u.query(), this.pageService.sendPV({}, this.sendPageCallback), document.addEventListener) "interactive" === document.readyState || "complete" === document.readyState ? this.domLoadedHandler() : u.bind(document, "DOMContentLoaded", function (t) {
                    return function () {
    ...
    14: [function (t, e, r) {
        ...
        s = t("../tools/utils"), o = ["load-plugin", "circle-mode", "browse-mode"], n = ["load-plugin", "register-iframe", "circle-mode", "browse-mode", "page-load", "circle-load"], i = function () {
            function t() {
                this.registerInnerIframe = a(this.registerInnerIframe, this), this.sendPageLoad = a(this.sendPageLoad, this), this.isSdkEvent = a(this.isSdkEvent, this), this.allowOrigin = window.vds.origin, this.bindEvents()
            }
            return t.prototype.bindEvents = function () {
                return s.bind(window, "message", function (t) {
                    return function (e) {
                        var r, i, n, a;
                        if (r = e.data, r.ai === window.vds.accountId && (i = r.mode || r.circleMode, t.isSdkEvent(i) && (!r.fsna || "sdk" === r.fsna))) {
                            ...
                            else if (r.tna !== window.grSource.name && r.tna && r.tid && s.isSpreadPostMessage()) return void s.spreadToInnerIframes(r);
                            if (a = r.mode, u.call(o, a) >= 0 || r.tna === window.grSource.name || e.origin === window.vds.origin || -1 !== s.indexOf(["www.growingio.com", "growingio.com"], e.origin.split("://")[1])) switch (e.origin !== window.vds.origin && (window.vds.origin = e.origin), r.mode) {
                                case "load-plugin":
                ...
                var e, r, i, n, o;
                null == t && (t = null), n = (null != (i = window.vds) ? i.pathCaseSensitive : void 0) ? window.location.toString() : window.location.toString().toLowerCase();
                ...
                var t, e, r, i, n, o, a, u;
                for (this.pluginLoaded = !1, t = s.getCirclePluginFileName(window._gr_support_circle_pop_out), a = document.getElementsByTagName("script"), n = 0, o = a.length; o > n; n++)
        ...
        n = t("./tools/utils"), i = function () {
            ...
            return t.prototype.replaceProps = function (t) {
                ...
                if (r = {
                    ...
                    }, n.query().length > 0 && (r.q = n.query()), t = this.gruser.getCs1(), t && (r.cs1 = t), window.gio && (r.appId = window.vds.appId), this.properties)
                ...
                }, n.query().length > 0 && (e.q = n.query()), t = this.gruser.getCs1(), t && (e.cs1 = t), window.gio && (e.appId = window.vds.appId), e
            }, t.prototype.sendPVOnSidChanged = function (t) {
                var e, r, i;
                return e = this.gruser.currentSessionId(), i = e[0], r = e[1], this.gruser.lastSessionId !== i ? (i || (i = this.gruser.guid(), this.gruser.resetUserId()), this.gruser.updateSessionId(i, !1), this.sendPV({
                    sendVisit: !0,
                    useNewTime: !0
                }, t)) : void 0
            }, t
    ...
    16: [function (t, e, r) {
        ...
        i = function () {
            ...
            return t = (new Date).getTime(), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (e) {
                var r, i;
                return r = (t + 16 * Math.random()) % 16 | 0, t = Math.floor(t / 16), i = "x" === e ? r : 3 & r | 8, i.toString(16)
            })
        }, e.exports = i
    }, {}],
    17: [function (t, e, r) {
    ...
    18: [function (t, e, r) {
        ...
        o = t("./guid"), i = t("./local_store"), n = t("../vendor/cookie"), s = {
            bind: function (t, e, r, i) {
                return null == i && (i = !1), null != document.addEventListener ? t.addEventListener(e, r, i) : null != document.attachEvent ? t.attachEvent("on" + e, function () {
                    var e;
            ...
            identityWindow: function () {
                var t, e;
                return t = o(), e = this.getWindowSourceName(), e && "grcw" === e || (window.top === window.self ? e = "grcw-outer-iframe" : (this.printWarning("检测到疑似window复写或者嵌套iframe。 window.name值: " + e), e = "grcw-inner-iframe")), window.grSource = {
                    name: e,
                    id: t
                }
            },
            ...
            functionDeserialization: function (t) {
                var e, r, i;
                return "string" == typeof t && (i = /function[^\(]*\(([^\)]*)\)[^\{]*{([^\}]*)\}/, r = t.match(i)) ? (e = r[1].split(",").map(arg(function () {
            ...
            parentOfLeafText: function (t) {
                ...
                for (a = t.childNodes, n = 0, o = a.length; o > n; n++) e = a[n], 3 === e.nodeType && (null != e.textContent ? r = e.textContent.trim() : null != e.data && (r = e.data.trim()), r.length > 0 && (i += r + " "));
            ...
            detectIE: function () {
                var t, e, r, i, n;
                return n = window.navigator.userAgent, window.ActiveXObject && (e = n.indexOf("MSIE "), e > 0) ? parseInt(n.substring(e + 5, n.indexOf(".", e)), 10) : (i = n.indexOf("Trident/"), i > 0 ? (r = n.indexOf("rv:"), parseInt(n.substring(r + 3, n.indexOf(".", r)), 10)) : (t = n.indexOf("Edge/"), t > 0 ? parseInt(n.substring(t + 5, n.indexOf(".", t)), 10) : !1))
            },
            hashCode: function (t) {
                var e, r, i;
            ...
            sendRequest: function (t, e, r) {
                ...
                if (window.XMLHttpRequest) {
                    if (i = new XMLHttpRequest, "withCredentials" in i) return i.open("GET", t, !0), i.withCredentials = !0, i.onreadystatechange = function () {
                        return 4 === i.readyState ? "function" == typeof e ? e(i) : void 0 : "function" == typeof r ? r(i) : void 0
                    }, i.send();
                    if ("undefined" != typeof XDomainRequest) return i = new XDomainRequest, "http:" === document.location.protocol && (t = t.replace("https://", "http://")), i.open("GET", t), i.onload = function (t) {
                        return function () {
            ...
            spreadToInnerIframes: function (t) {
                var e, r, i, n, o;
                for (r = document.getElementsByTagName("iframe"), o = [], i = 0, n = r.length; n > i; i++) e = r[i], o.push(this.spread(t, e));
                return o
            },
            spread: function (t, e) {
                var r;
            ...
            vaildVar: function (t) {
                ...
                if (i = null, null != t)
                    for (r in t)
                        if (n = t[r], null == i && (i = {}), e = r.length <= 50 ? r : r.slice(0, 50), null != n && "string" == typeof n && n.constructor === String && (n = n.length <= 1e3 ? n : n.slice(0, 1e3)), i[e] = n, this.getOwnPropertyNames(i).length >= 100) return i;
                return i
            },
        ...
        var i = /^(\.br\.|\.co\.|\.com\.|\.org\.|\.edu\.|\.net\.)/,
            n = {
                ...
                setItem: function (t, e, r, i, n, o) {
                    ...
                    return document.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + s + (n ? "; domain=" + n : "") + (i ? "; path=" + i : "") + (o ? "; secure" : ""), !0
                },
                    ...
                    switch (u && "object" == typeof u && "function" == typeof u.toJSON && (u = u.toJSON(t)), "function" == typeof rep && (u = rep.call(e, t, u)), typeof u) {
                        ...
                        case "object":
                            ...
                            if (rep && "object" == typeof rep)
                                for (o = rep.length, r = 0; o > r; r += 1) "string" == typeof rep[r] && (i = rep[r], n = str(i, u), n && s.push(quote(i) + (gap ? ": " : ":") + n));
                            else
                                for (i in u) Object.prototype.hasOwnProperty.call(u, i) && (n = str(i, u), n && s.push(quote(i) + (gap ? ": " : ":") + n));
                            return n = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, n
                    }
                }
                var rx_one = /^[\],:{}\s]*$/,
                ...
                "function" != typeof JSON.stringify && (meta = {
                    ...
                    function walk(t, e) {
                        ...
                        if (n && "object" == typeof n)
                            for (r in n) Object.prototype.hasOwnProperty.call(n, r) && (i = walk(n, r), void 0 !== i ? n[r] = i : delete n[r]);
                ...
                r = {
                    ...
                    _compress: function (t, e, r) {
                        ...
                        for (o = 0; o < t.length; o += 1)
                            if (u = t.charAt(o), Object.prototype.hasOwnProperty.call(s, u) || (s[u] = l++, a[u] = !0), c = d + u, Object.prototype.hasOwnProperty.call(s, c)) d = c;
                            else {
                                if (Object.prototype.hasOwnProperty.call(a, d)) {
                                    if (d.charCodeAt(0) < 256) {
                                        for (i = 0; p > i; i++) g <<= 1, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++;
                                        for (n = d.charCodeAt(0), i = 0; 8 > i; i++) g = g << 1 | 1 & n, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++, n >>= 1
                                    } else {
                                        for (n = 1, i = 0; p > i; i++) g = g << 1 | n, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++, n = 0;
                                        for (n = d.charCodeAt(0), i = 0; 16 > i; i++) g = g << 1 | 1 & n, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++, n >>= 1
                                    }
                                    h--, 0 == h && (h = Math.pow(2, p), p++), delete a[d]
                                } else
                                    for (n = s[d], i = 0; p > i; i++) g = g << 1 | 1 & n, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++, n >>= 1;
    ...
    22: [function (t, e, r) {
        ...
        if (!u) throw console && console.error("DOM Mutation Observers are required."), console && console.error("https://developer.mozilla.org/en-US/docs/DOM/MutationObserver"), Error("DOM Mutation Observers are required");
        var c, d = function () {
            function t() {
        ...
        var h = function () {
                function t(t, e, r, i, n, o, s, a) {
                    void 0 === e && (e = !1), void 0 === r && (r = !1), void 0 === i && (i = !1), void 0 === n && (n = null), void 0 === o && (o = !1), void 0 === s && (s = null), void 0 === a && (a = null), this.node = t, this.childList = e, this.attributes = r, this.characterData = i, this.oldParentNode = n, this.added = o, this.attributeOldValues = s, this.characterDataOldValue = a, this.isCaseInsensitive = this.node.nodeType === Node.ELEMENT_NODE && this.node instanceof HTMLElement, this.isCaseInsensitive && (this.isCaseInsensitive = "undefined" != typeof HTMLDocument ? this.node.ownerDocument instanceof HTMLDocument : this.node.ownerDocument instanceof Document)
                }
            ...
            f = function () {
                function t(t, e, r, i, n) {
                    this.rootNode = t, this.mutations = e, this.selectors = r, this.calcReordered = i, this.calcOldPreviousSibling = n, this.treeChanges = new p(t, e), this.entered = [], this.exited = [], this.stayedIn = new d, this.visited = new d, this.childListChangeMap = void 0, this.characterDataOnly = void 0, this.matchCache = void 0, this.processMutations()
                }
                return t.prototype.processMutations = function () {
                    ...
                    if (!this.visited.has(t)) {
                        ...
                        if ((r && r.childList || void 0 == i) && (i = this.treeChanges.reachabilityChange(t)), i !== c.STAYED_OUT) {
                            if (this.matchabilityChange(t), i === c.ENTERED) this.entered.push(t);
                                ...
                                var n = c.STAYED_IN;
                                r && r.childList && (r.oldParentNode !== t.parentNode ? (n = c.REPARENTED, this.ensureHasOldPreviousSiblingIfNeeded(t)) : this.calcReordered && this.wasReordered(t) && (n = c.REORDERED)), this.stayedIn.set(t, n)
                            }
                            if (i !== c.STAYED_IN)
                    ...
                    for (var s = this.stayedIn.keys(), i = 0; i < s.length; i++) {
                        ...
                        if (o === c.ENTERED) t.added.push(n);
                            ...
                            t.reparented && a === c.REPARENTED ? t.reparented.push(n) : t.reordered && a === c.REORDERED && t.reordered.push(n)
                        }
                    }
                    ...
                    function e(t) {
                        ...
                        var e = s.moved.get(t);
                        return void 0 !== e ? e : (a.has(t) ? e = !0 : (a.set(t, !0), e = i(t) !== r(t)), a.has(t) ? (a.remove(t), s.moved.set(t, e)) : e = s.moved.get(t), e)
                    }
            ...
            g = function () {
                function t(t, e) {
                    ...
                    if (this.projection = t, this.added = [], this.removed = [], this.reparented = e.all || e.element || e.characterData ? [] : void 0, this.reordered = e.all ? [] : void 0, t.getChanged(this, e.elementFilter, e.characterData), e.all || e.attribute || e.attributeList) {
                        ...
                        e.attribute ? this.valueChanged = n[e.attribute] || [] : (this.attributeChanged = n, e.attributeList && e.attributeList.forEach(function (t) {
            ...
            w = function () {
                ...
                return t.prototype.matches = function (t) {
                    ...
                    return "class" === this.attrName && this.contains ? "." + this.attrValue : "id" !== this.attrName || this.contains ? this.contains ? "[" + this.attrName + "~=" + i(this.attrValue) + "]" : "attrValue" in this ? "[" + this.attrName + "=" + i(this.attrValue) + "]" : "[" + this.attrName + "]" : "#" + this.attrValue
                }, t
            }(),
            y = function () {
                function t() {
                ...
                return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                    ...
                    for (var n, o, s, a = [], u = /\s/, c = "Invalid or unsupported selector syntax.", d = 1, h = 2, l = 3, p = 4, f = 5, g = 6, y = 7, b = 8, _ = 9, S = 10, C = 11, O = 12, I = 13, N = 14, x = d, E = 0; E < e.length;) {
                        var T = e[E++];
                        switch (x) {
                            case d:
                                if (T.match(v)) {
                ...
                return t.createObserverOptions = function (t) {
                    ...
                    for (var i = {
                        ...
                        if (a.all) {
                            ...
                            if (a.hasOwnProperty("elementAttributes") && (u.attributeList = o(a.elementAttributes), c--), c > 1) throw Error("Invalid request option. element only allows elementAttributes option.");
                            i.queries.push(u)
                        } else {
                    ...
                    for (var e = new f(this.root, t, this.elementFilter, this.calcReordered, this.options.oldPreviousSibling), r = [], i = 0; i < this.options.queries.length; i++) r.push(new g(e, this.options.queries[i]));
                    return r
                    ...
                    if (void 0 === e) {
                        ...
                        for (var d = t.parentElement; d && "BODY" !== d.tagName && "HTML" !== d.tagName;) {
                            ...
                            if (l && null === l.match(/^[0-9]/) && (h += "#" + l), d.hasAttribute("class"))
                                for (var p = d.getAttribute("class").trim().split(/\s+/).sort(), f = 0; f < p.length; f++) p[f].length > 0 && null === o.exec(p[f]) && (h += "." + p[f]);
                            ...
                            if (e += "/", w.childNodes.length > 0) {
                                ...
                                if (O)
                                    for (var I = w.firstChild; I; I = I.nextSibling)
                                        if (1 === I.nodeType && -1 === a.indexOf(I.tagName)) {
                                            O = !1;
                                            break
                                        } for (var N = w.firstChild; N; N = N.nextSibling) {
                                    if (_ = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null, S = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1, 1 === N.nodeType) {
                                        if (1 === i[N.tagName]) {
                                            b = !1;
                                            continue
                                        }
                                        if (N.hasAttribute("growing-ignore") || N.hasAttribute("data-growing-ignore")) continue;
                                        if (O && -1 !== a.indexOf(N.tagName) && (b = !1, !N.children || 0 === N.children.length)) continue; - 1 !== n.indexOf(N.tagName) && (C += 1, S = C), N.hasAttribute("data-growing-idx") && (C = parseInt(N.getAttribute("data-growing-idx")), S = C), N.hasAttribute("data-growing-info") && (_ = N.getAttribute("data-growing-info"))
                                    }
                        ...
                        if (t && 1 !== i[t.tagName]) {
                            ...
                            if (e && !u[a.nodeId(e)] && "undefined" != typeof e.getAttribute) {
                                ...
                                if (!r || -1 === r.toLowerCase().indexOf("clock") && -1 === r.toLowerCase().indexOf("countdown") && -1 === r.toLowerCase().indexOf("time"))
                                    if (!n || -1 === n.toLowerCase().indexOf("clock") && -1 === n.toLowerCase().indexOf("countdown") && -1 === n.toLowerCase().indexOf("time"))
    ...
    26: [function (t, e, r) {
        ...
        i = t("../../core/info/gr_user_info"), n = function (t) {
            ...
            return o(e, t), e.prototype.duration10year = 31536e4, e.prototype.duration30min = 1800, e.prototype.duration15min = 9e5, e.prototype.duration1min = 6e4, e.prototype.cookieDomain = function () {
                var t, e;
                ...
                return this.userId ? this.userId : (this.userId = this.cookie.getItem("gr_user_id"), this.userId ? this.cookie.setItem("gr_user_id", this.userId, this.duration10year, "/", this.cookieDomain()) : (this.userId = this.guid(), this.cookie.setItem("gr_user_id", this.userId, this.duration10year, "/", this.cookieDomain())), this.userId)
            }, e.prototype.hasSid = function () {
                var t, e, r, i;
                return e = +Date.now(), this.sessionId && this.lastUpdated && e - this.lastUpdated < this.duration15min ? !0 : (r = this.currentSessionId(), t = r[0], i = r[1], t && (!this.lastSessionId || t === this.lastSessionId))
            }, e.prototype.sid = function () {
                var t, e, r;
                return e = this.currentSessionId(), this.sessionId = e[0], r = e[1], t = +Date.now(), this.sessionId && this.lastUpdated && t - this.lastUpdated < this.duration1min ? this.sessionId : (this.sessionId || (this.sessionId = this.guid(), r = !1), this.updateSessionId(this.sessionId, r), this.updateCS1(this.getCs1(), this.sessionId), this.sessionId)
                ...
                var r;
                return null == e && (e = this.sessionId), r = window.vds.accountId, t ? (this.clearCs1(), this.cookie.setItem(r + "_gr_last_sent_sid_with_cs1", e, this.duration30min, "/", this.cookieDomain()), this.cookie.setItem(r + "_gr_last_sent_cs1", t, this.duration10year, "/", this.cookieDomain()), this.cookie.setItem(r + "_gr_cs1", t, this.duration10year, "/", this.cookieDomain())) : void 0
                ...
                var e, r, i;
                return null == t && (t = window.vds.accountId), i = this.cookie.getItem(t + "_gr_session_id") || "", r = "true" === this.cookie.getItem(t + "_gr_session_id_" + i), i && i.indexOf("_") >= 0 && (e = i.split("_"), i = e[0], r = e[1], r = "true" === r, this.updateSessionId(i, r)), i && "null" === i && (i = "", r = !1), [i, r]
            }, e.prototype.updateSessionId = function (t, e, r) {
                var i;
                return this.lastSessionId !== t && this.visitorVar && (i = !0), t ? (r || (r = window.vds.accountId), this.lastUpdated = +Date.now(), this.lastSessionId = t, this.updateSessionIdSendStatus(e, t, r), this.cookie.setItem(r + "_gr_session_id", t, this.duration30min, "/", this.cookieDomain()), i && this.currentSessionId()[0] ? window.gio("visitor.set", this.visitorVar) : void 0) : (console && console.error("sid shoud not be empty!"), this.sessionId = this.guid(), void this.updateSessionId(this.sessionId, e, r))
                ...
                return this.userId ? this.cookie.setItem("gr_user_id", this.userId, this.duration10year, "/", this.cookieDomain()) : void 0
            }, e
        }(i), e.exports = n
    }, {
    ...
    27: [function (t, e, r) {
        var i, n, o, s, a, u, c, d, h = function (t, e) {
            ...
            p = {}.hasOwnProperty;
        n = t("./observer/dom_observer"), s = t("./sender"), i = t("../core/base_launcher"), u = t("./info/dom_info"), d = t("../core/tools/utils"), a = d.detectIE() || 0 / 0, c = void 0, 9 > a || (window.MutationObserver = t("mutation-observer"), c = t("tree-mirror")), o = function (t) {
            function e() {
                this.defaultSamplingFunc = h(this.defaultSamplingFunc, this), this.user = u.user(), e.__super__.constructor.call(this), this.sender = new s(this.user, this.callback), this.observer = new n(this.sender, this.user, this, c)
            }
            return l(e, t), e.prototype.afterInitialize = function () {}, e.prototype.setListener = function (t) {
    ...
    28: [function (t, e, r) {
        var i, n, o, s, a, u, c, d, h, l = [].slice;
        if (t("../core/vendor/shim"), h = t("../core/tools/utils"), i = t("./launcher"), s = new i, window._gr_support_circle_pop_out = !0, !window._disable_js_vds && ("boolean" != typeof window.webViewRequestSend || window.webViewRequestSend || !window._vds_ios && !window._vds_bridge) && (window._vds_hybrid || window._gr_ignore_local_rule || -1 === h.indexOf(["", "localhost", "127.0.0.1"], window.location.hostname))) {
            if (null != window.grSdkInstalled) return void h.printWarning("重复加载GrowingIO SDK");
            for (window.grSdkInstalled = !0, c = [], window.gio && window.gio.web ? c = c.concat(window.gio.web) : ((null != (d = window.gio) ? d.q : void 0) && (c = c.concat(window.gio.q)), window._vds && (c = c.concat(window._vds))), o = 0, a = c.length; a > o; o++) u = c[o], null != s && s.apply.apply(s, u);
            n = function () {
                var t;
                return t = 1 <= arguments.length ? l.call(arguments, 0) : [], s.apply.apply(s, t)
            }, n.push = function () {
                return arguments.length > 1 ? s.apply.apply(s, arguments) : s.apply.apply(s, arguments[0])
            }, n.track = function () {
                var t;
                return (t = s.system).track.apply(t, arguments)
            }, n.platform = "web", window.gioGlobalArray = window.gioGlobalArray || [], window.gioGlobalArray.push(n), window.gio = function () {
                var t, e, r, i, n, o;
                for ((window._vds_bridge || window._vds_ios) && 1 === window.gioGlobalArray.length && window.gio && window.gio.hybrid && window.gio.hybrid.push(arguments), i = window.gioGlobalArray, o = [], e = 0, r = i.length; r > e; e++) t = i[e], o.push("init" === (n = arguments[0]) || "send" === n ? "web" === t.platform ? t.apply(null, arguments) : void 0 : t.apply(null, arguments));
                return o
            }, (window._vds_bridge || window._vds_ios) && 1 === window.gioGlobalArray.length && (window.gio.hybrid = c), window.gio.web = void 0, window._vds = {
                push: function () {
                    var t, e, r, i, n;
                    for (i = window.gioGlobalArray, n = [], e = 0, r = i.length; r > e; e++) t = i[e], n.push(t.push.apply(t, arguments));
                    return n
                },
                track: function () {
                    var t, e, r, i, n;
                    for (i = window.gioGlobalArray, n = [], e = 0, r = i.length; r > e; e++) t = i[e], n.push(t.track.apply(t, arguments));
                    return n
                }
            }
        }
    ...
    29: [function (t, e, r) {
        var i, n, o, s, a, u = function (t, e) {
            ...
            c = {}.hasOwnProperty;
        i = t("../../core/observer/dom_observer"), s = t("../info/dom_info"), o = t("./server_imp_setting"), a = t("../../core/tools/utils.coffee"), n = function (t) {
            function e(t, r, i, n) {
                this.sender = t, this.gruser = r, this.launcher = i, this.TreeMirror = n, this.info = s, e.__super__.constructor.call(this, this.sender, this.gruser, this.launcher, this.TreeMirror)
            }
            return u(e, t), e.prototype.snapshotCallback = function (t, e) {}, e.prototype.appendMessageAttrs = function (t, e) {
                ...
                var t;
                return t = !1, window.vds.sampling && (a.functionDeserialization(window.vds.sampling_func).call(this) || (t = !0)), window.grBlind = t, t
            }, e
        }(i), e.exports = n
    }, {
    ...
    30: [function (t, e, r) {
        ...
        o = t("cookie"), s = t("../../core/tools/utils"), i = t("../../core/tools/local_store"), n = function () {
            ...
            return t.initialize = function () {
                ...
                var t, e, r;
                return r = (null != (t = window.vds) ? t.zone : void 0) ? "-" + window.vds.zone : "", e = ("https:" === document.location.protocol ? "https://" : "http://") + "tags" + r + (".growingio.com/products/" + window.vds.accountId + "/web/" + window.location.hostname + "/settings/general"), s.sendRequest(e, function (t) {
                    return function (t) {
                        var e;
                        return e = (null != t ? t.responseText : void 0) ? JSON.parse(t.responseText).imp : !0, i.set("gr_imp_" + s.hashCode(window.vds.accountId), e), window.vds.imp &= e, window.vds.imp ? void 0 : window._vds.push(["deregisterDomObserver"])
                    }
                }(this))
            }, t
        }(), e.exports = n
    ...
    31: [function (t, e, r) {
        ...
        u = t("lzstring"), h = t("../core/tools/utils"), s = h.detectIE() || 0 / 0, c = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), o = c ? parseInt(c[2], 10) : !1, a = !1, o && 22 > o ? i = !1 : (i = !0, d = navigator.userAgent, "ArrayBufferView" in window || (-1 !== d.indexOf("Android") ? i = !1 : -1 !== d.indexOf("CPU OS ") ? -1 !== d.indexOf("CPU OS 6_") ? i = !1 : -1 !== d.indexOf("CPU OS 5_") ? i = !1 : -1 !== d.indexOf("CPU OS 4_") ? i = !1 : -1 !== d.indexOf("CPU OS 3_") && (i = !1) : -1 !== d.indexOf("CPU iPhone OS ") ? -1 !== d.indexOf("iPhone OS 6_") ? i = !1 : -1 !== d.indexOf("iPhone OS 5_") ? i = !1 : -1 !== d.indexOf("iPhone OS 4_") && (i = !1) : -1 !== d.indexOf("Intel Mac OS X") && (-1 !== d.indexOf("Mac OS X 10_6") ? i = !1 : -1 !== d.indexOf("Mac OS X 10_7") && (i = !1)))), n = function () {
            function t(t, e) {
                this.user = t, this.callback = e, this.setListener = l(this.setListener, this), this.dispathMessage2Listener = l(this.dispathMessage2Listener, this), this.dispatchEvents = l(this.dispatchEvents, this), this.imgSendClear = l(this.imgSendClear, this), this.addRealTimeMessageCallBack = l(this.addRealTimeMessageCallBack, this), this.send = l(this.send, this), this.listeners = [], this.typeListAccepted = ["page", "vst", "clck", "imp", "chng", "sbmt", "cstm", "pvar", "evar", "ppl", "reengage", "vstr"], this.typeListReceivedValid = [], this.setRealTimeMessageCallBack = null
            }
            var e, r;
            return r = [], e = [], t.prototype.sendVisitTimeout = 0, t.prototype.setUrlMap = function (t) {
                ...
                var e, r;
                return r = t.zone && "api.growingio.com" === t.host ? t.scheme + ("api-" + t.zone + ".growingio.com") : t.scheme + t.host, e = r + "/v2/" + t.accountId + "/web", {
                    pv: e + "/pv",
                    action: e + "/action",
                ...
                var r, i, n, o, c, d, h;
                if (null == e && (e = "action"), !window.vds.dataCollect && !window.grBlind && ("boolean" != typeof window.webViewRequestSend || window.webViewRequestSend || !window._vds_ios && !window._vds_bridge)) try {
                    if (h = "pv" === e && 2 === t.length ? t[0].s : "", r = "undefined" == typeof Uint8Array || null === Uint8Array || a ? window.XMLHttpRequest && 7 !== s && !a ? u.compressToUTF16(JSON.stringify(t)) : u.compressToEncodedURIComponent(JSON.stringify(t)) : u.compressToUint8Array(JSON.stringify(t)), this.sendRemote(r, e, h), this.typeListReceivedValid.length >= 0 && this.setRealTimeMessageCallBack)
                        for (n = 0, o = t.length; o > n; n++) c = t[n], d = c.t, p.call(this.typeListReceivedValid, d) >= 0 && this.setRealTimeMessageCallBack(c);
                    ...
                    return i = l, console && console.warn(i)
                }
            }, t.prototype.addRealTimeMessageCallBack = function (t, e) {
                var r, i, n, o, s;
                try {
                    if (Array.isArray(t))
                        for (n = 0, o = t.length; o > n; n++) i = t[n], p.call(this.typeListAccepted, i) >= 0 && this.typeListReceivedValid.push(i);
                    else {
                        if (s = t.toString(), !(p.call(this.typeListAccepted, s) >= 0)) throw Error("The second parameter requires an array.");
                ...
                var u, c, d;
                return this.urlMap || (this.urlMap = this.getUrlMap(window.vds)), d = this.urlMap[n], window.grWaitTime = +Date.now() + 300, "" !== o && (this.sendVisitTimeout += 300), window.XMLHttpRequest && 7 !== s && !a ? (u = new XMLHttpRequest, "withCredentials" in u ? (u.open("POST", d + "?stm=" + +Date.now(), !0), u.withCredentials = !0, u.onreadystatechange = function (t) {
                    return function () {
                        return 4 === u.readyState && ("" !== o && (t.sendVisitTimeout -= 300), t.removeAjax(u), window.grWaitTime = +Date.now() + 10, o && "" !== o && 200 === u.status) ? t.user.updateSessionIdSendStatus(!0, o) : void 0
                    }
                }(this), u.send("undefined" != typeof ArrayBuffer && null !== ArrayBuffer ? i ? t : t.buffer : t), e.push(u)) : "undefined" != typeof XDomainRequest && (u = new XDomainRequest, "http:" === document.location.protocol && (d = d.replace("https://", "http://")), u.open("POST", d + "?stm=" + +Date.now()), u.onload = function (t) {
                    return function () {
                    ...
                    return {}
                }, u.send(t), r.push(u))) : ("http:" === document.location.protocol && (d = d.replace("https://", "http://")), c = d + "?data=" + t + "&stm=" + +Date.now(), c.length <= 2036 && this.imgSend(c, o)), window.trackHostUrl = d
            }, t.prototype.removeAjax = function (t) {
                var r;
                return r = e.indexOf(t), -1 !== r ? e.splice(r, 1) : void 0
            }, t.prototype.removeXDR = function (t, e) {
                var i;
                return i = h.indexOf(r, t), -1 !== i && r.splice(i, 1), window.grWaitTime = +Date.now() + 10, "" !== e ? this.sendVisitTimeout -= 300 : void 0
